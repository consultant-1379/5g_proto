...
final class EthernetPacket
{
    ...
    /**
     * Write IPv4 Ethernet Packet. It uses a dummy MAC address for both source and
     * destination.
     *
     * @param byteBuf ByteBuf where Ethernet Packet data will be set
     * @param payload Payload of IPv4
     */
    static void writeIPv4(ByteBuf byteBuf,
                          ByteBuf payload)
    {
    ...
    /**
     * Write IPv6 Ethernet Packet. It uses a dummy MAC address for both source and
     * destination.
     *
     * @param byteBuf ByteBuf where Ethernet Packet data will be set
     * @param payload Payload of IPv6
     */
    static void writeIPv6(ByteBuf byteBuf,
                          ByteBuf payload)
    {
     ...
     */
    private static void writePacket(ByteBuf byteBuf,
                                    ByteBuf payload,
                                    byte[] srcAddress,
                                    byte[] dstAddress,
                                    int type)
