...
final class PcapWriter implements Closeable
{
    ...
    /**
     * This uses {@link OutputStream} for writing Pcap. Pcap Global Header is not
    ...
    /**
     * This uses {@link OutputStream} for writing Pcap. Pcap Global Header is also
     * written on construction.
     *
                     ...
                     ByteBuf packet) throws IOException
    {
        ...
        PcapHeaders.writePacketHeader(packetHeaderBuf,
                                      (int) (timestamp / 1000L),
