 ...
 */
public class FmAlarmServiceImpl implements FmAlarmService
{
    private static final Long CEASE_EXPIRATION = 0L;
    private final FmAlarmHandler alarmHandler;

    public FmAlarmServiceImpl(FmAlarmHandler alarmHandler)
    {
    ...
    {
        return this.alarmHandler.indicatingFault(faultIndication);
    }
