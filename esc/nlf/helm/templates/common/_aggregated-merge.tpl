...
{{- define "eric-sc-nlf.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sc-nlf.mergeAnnotations" -}}
  {{- include "eric-sc-nlf.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sc-nlf.mergeLabels" -}}
  {{- include "eric-sc-nlf.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
