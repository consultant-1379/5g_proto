...
class NnrfNfDiscoveryTest
{
    ...
    // @Test
    void testDeserializationOfDiscoveredData()
    {
        final String discoveredData = "{" + "  \"validityPeriod\": 86370," + "  \"nfInstances\": [" + "    {" + "      \"ipv4Addresses\": ["
                                      + "        \"10.81.143.48\"" + "      ]," + "      \"nfInstanceId\": \"1c306803-0558-4ef7-9efd-4e02e9779278\","
                                      + "      \"nfStatus\": \"REGISTERED\"," + "      \"locality\": \"cnistb4\"," + "      \"nfType\": \"SMF\","
                                      + "      \"plmnList\": [" + "        {" + "          \"mnc\": \"03\"," + "          \"mcc\": \"262\"" + "        },"
                                      + "        {" + "          \"mnc\": \"07\"," + "          \"mcc\": \"262\"" + "        }" + "      ],"
                                      + "      \"priority\": 10," + "      \"sNssais\": [" + "        {" + "          \"sst\": 1,"
                                      + "          \"sd\": \"000001\"" + "        }" + "      ],"
                                      + "      \"fqdn\": \"esmftb4.tb4.lab.default.smf.5gc.mnc007.mcc262.3gppnetwork.org\"," + "      \"smfInfo\": {"
                                      + "        \"sNssaiSmfInfoList\": [" + "          {" + "            \"dnnSmfInfoList\": [" + "              {"
                                      + "                \"dnn\": \"galaxy-test-tb\"" + "              }," + "              {"
                                      + "                \"dnn\": [\"ims\", \"imms\"]" + "              }," + "              {"
                                      + "                \"dnn\": \"internet-tb\"" + "              }," + "              {"
                                      + "                \"dnn\": \"nbiot-sm2m.telefonica.de\"" + "              }," + "              {"
                                      + "                \"dnn\": \"nonaas\"" + "              }," + "              {" + "                \"dnn\": \"sos\""
                                      + "              }" + "            ]," + "            \"sNssai\": {" + "              \"sst\": 1" + "            }"
                                      + "          }," + "          {" + "            \"dnnSmfInfoList\": [" + "              {"
                                      + "                \"dnn\": \"galaxy-test-tb\"" + "              }," + "              {"
                                      + "                \"dnn\": \"ims\"" + "              }," + "              {" + "                \"dnn\": \"internet-tb\""
                                      + "              }," + "              {" + "                \"dnn\": \"nbiot-sm2m.telefonica.de\"" + "              },"
                                      + "              {" + "                \"dnn\": \"nonaas\"" + "              }," + "              {"
                                      + "                \"dnn\": \"sos\"" + "              }" + "            ]," + "            \"sNssai\": {"
                                      + "              \"sd\": \"000001\"," + "              \"sst\": 1" + "            }" + "          }," + "          {"
                                      + "            \"dnnSmfInfoList\": [" + "              {" + "                \"dnn\": \"internet-tb\"" + "              }"
                                      + "            ]," + "            \"sNssai\": {" + "              \"sd\": \"000128\"," + "              \"sst\": 128"
                                      + "            }" + "          }," + "          {" + "            \"dnnSmfInfoList\": [" + "              {"
                                      + "                \"dnn\": \"internet-tb\"" + "              }" + "            ]," + "            \"sNssai\": {"
                                      + "              \"sd\": \"000138\"," + "              \"sst\": 138" + "            }" + "          }," + "          {"
                                      + "            \"dnnSmfInfoList\": [" + "              {" + "                \"dnn\": \"internet-tb\"" + "              }"
                                      + "            ]," + "            \"sNssai\": {" + "              \"sd\": \"000148\"," + "              \"sst\": 148"
                                      + "            }" + "          }" + "        ],"
                                      + "        \"pgwFqdn\": \"topon.paif100.g1.esmftb4.tb1.node.epc.mnc007.mcc262.3gppnetwork.org\"" + "      },"
                                      + "      \"nfServices\": [" + "        {" + "          \"scheme\": \"http\"," + "          \"ipEndPoints\": ["
                                      + "            {" + "              \"port\": 7070," + "              \"ipv4Address\": \"10.81.143.48\"" + "            }"
                                      + "          ]," + "          \"versions\": [" + "            {" + "              \"apiFullVersion\": \"1.1.6\","
                                      + "              \"apiVersionInUri\": \"v1\"" + "            }" + "          ],"
                                      + "          \"nfServiceStatus\": \"REGISTERED\","
                                      + "          \"serviceInstanceId\": \"nsmf-pdusession.1c306803-0558-4ef7-9efd-4e02e9779278\","
                                      + "          \"serviceName\": \"nsmf-pdusession\"" + "        }" + "      ]" + "    }" + "  ],"
                                      + "  \"nrfSupportedFeatures\": \"71E\"" + "}";

        SearchResult profile;
        try
        {
            profile = OpenApiObjectMapper.singleton().readValue(discoveredData, SearchResult.class);
            log.info("{}", toJson(profile));

            JsonObject o = new JsonObject(discoveredData);
            log.info("{}", o);

            Integer validityPeriod = o.getInteger("validityPeriod");
            log.info("validityPeriod={}", validityPeriod);
            JsonArray nfInstances = o.getJsonArray("nfInstances");
            log.info("nfInstances={}", nfInstances);
            JsonObject nfInstance0 = o.getJsonArray("nfInstances").getJsonObject(0);
            log.info("nfInstance0={}", nfInstance0);
            JsonObject smfInfo0 = o.getJsonArray("nfInstances").getJsonObject(0).getJsonObject("smfInfo");
            log.info("smfInfo0={}", smfInfo0);
            JsonArray sNssaiSmfInfoList0 = o.getJsonArray("nfInstances").getJsonObject(0).getJsonObject("smfInfo").getJsonArray("sNssaiSmfInfoList");
            log.info("sNssaiSmfInfoList0={}", sNssaiSmfInfoList0);
            JsonArray dnnSmfInfoList0 = o.getJsonArray("nfInstances")
                                         .getJsonObject(0)
                                         .getJsonObject("smfInfo")
                                         .getJsonArray("sNssaiSmfInfoList")
                                         .getJsonObject(0)
                                         .getJsonArray("dnnSmfInfoList");
            log.info("dnnSmfInfoList0={}", dnnSmfInfoList0);
            dnnSmfInfoList0.forEach(p ->
            {
                log.info("p={}", p);

                if (p instanceof String)
                    log.info("dnnString={}", p);
                else if (p instanceof JsonObject)
                {
                    Object j = ((JsonObject) p).getValue("dnn");

                    if (j instanceof String)
                        log.info("dnnString={}", j);
                    else if (j instanceof JsonObject)
                        log.info("dnnObject={}", j);
