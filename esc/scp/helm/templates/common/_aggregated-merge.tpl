...
{{- define "eric-scp.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-scp.mergeAnnotations" -}}
  {{- include "eric-scp.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-scp.mergeLabels" -}}
  {{- include "eric-scp.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
