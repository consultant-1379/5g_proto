...
{{- define "eric-stm-diameter-proxy-grpc.log-shipper-sidecar-aggregated-merge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-stm-diameter-proxy-grpc.log-shipper-sidecar-merge-annotations" -}}
  {{- include "eric-stm-diameter-proxy-grpc.log-shipper-sidecar-aggregated-merge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-stm-diameter-proxy-grpc.log-shipper-sidecar-merge-labels" -}}
  {{- include "eric-stm-diameter-proxy-grpc.log-shipper-sidecar-aggregated-merge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}