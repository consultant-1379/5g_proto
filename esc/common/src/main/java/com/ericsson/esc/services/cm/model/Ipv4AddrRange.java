...
public class Ipv4AddrRange
{
    ...
    public Ipv4AddrRange withIpv4AddrStart(String ipv4AddrStart)
    {
        this.ipv4AddrStart = ipv4AddrStart;
        return this;
    }
    ...
    public Ipv4AddrRange withIpv4AddrEnd(String ipv4AddrEnd)
    {
        this.ipv4AddrEnd = ipv4AddrEnd;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(Ipv4AddrRange.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof Ipv4AddrRange) == false)
        {
            return false;
        }
        Ipv4AddrRange rhs = ((Ipv4AddrRange) other);
