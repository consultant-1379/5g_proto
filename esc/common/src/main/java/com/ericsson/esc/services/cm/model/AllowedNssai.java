...
public class AllowedNssai
{
    ...
    public AllowedNssai withSst(Integer sst)
    {
        this.sst = sst;
        return this;
    }
    ...
    public AllowedNssai withSd(String sd)
    {
        this.sd = sd;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AllowedNssai.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sst");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AllowedNssai) == false)
        {
            return false;
        }
        AllowedNssai rhs = ((AllowedNssai) other);
