...
public class SearchReplaceRegex__1
{
    ...
    public SearchReplaceRegex__1 withSearchRegex(String searchRegex)
    {
        this.searchRegex = searchRegex;
        return this;
    }
    ...
    public SearchReplaceRegex__1 withReplaceAllOccurrences(Boolean replaceAllOccurrences)
    {
        this.replaceAllOccurrences = replaceAllOccurrences;
        return this;
    }
    ...
    public SearchReplaceRegex__1 withReplaceValue(String replaceValue)
    {
        this.replaceValue = replaceValue;
        return this;
    }
    ...
    public SearchReplaceRegex__1 withReplaceFromVarName(String replaceFromVarName)
    {
        this.replaceFromVarName = replaceFromVarName;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(SearchReplaceRegex__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof SearchReplaceRegex__1) == false)
        {
            return false;
        }
        SearchReplaceRegex__1 rhs = ((SearchReplaceRegex__1) other);
