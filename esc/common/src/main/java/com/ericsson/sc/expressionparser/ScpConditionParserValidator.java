 ...
 * 
 */
public class ScpConditionParserValidator extends ScpMatchConditionParserBaseVisitor<OperandType>
{

    @Override
    public OperandType visitRoot(ScpMatchConditionParser.RootContext ctx)
    {
        ...
        if (type != OperandType.BOOL)
        {
            throw new ParseException(0,
                                     0,
                                     String.format("Scp match condition should always return %s. Instead it returned %s",
    ...
    @Override
    public OperandType visitNfDataKnown(ScpMatchConditionParser.NfDataKnownContext ctx)
    {
        return OperandType.NFDATA;
    }

    @Override
    public OperandType visitNfDataUnknown(ScpMatchConditionParser.NfDataUnknownContext ctx)
    {
        return OperandType.NFDATA;
    }

    @Override
    public OperandType visitNfDataScp(ScpMatchConditionParser.NfDataScpContext ctx)
    {
        return OperandType.NFDATA;
    }

    @Override
    public OperandType visitNfDataScpDomainInfo(ScpMatchConditionParser.NfDataScpDomainInfoContext ctx)
    {
        return OperandType.NFDATA;
    }

    @Override
    public OperandType visitNfDataIpEndpoint(ScpMatchConditionParser.NfDataIpEndpointContext ctx)
    {
        return OperandType.NFDATA;
    }

    @Override
    public OperandType visitVar(ScpMatchConditionParser.VarContext ctx)
    {
        return OperandType.DATA;
    }

    @Override
    public OperandType visitLiteralStr(ScpMatchConditionParser.LiteralStrContext ctx)
    {
        return OperandType.STRING;
    }

    @Override
    public OperandType visitLiteralBool(ScpMatchConditionParser.LiteralBoolContext ctx)
    {
        return OperandType.BOOL;
    }

    @Override
    public OperandType visitBinaryExpr(ScpMatchConditionParser.BinaryExprContext ctx)
    {
    ...
    @Override
    public OperandType visitParentheticExpr(ScpMatchConditionParser.ParentheticExprContext ctx)
    {
        return visit(ctx.expr);
    }

    @Override
    public OperandType visitUnaryExpr(ScpMatchConditionParser.UnaryExprContext ctx)
    {
    ...
    public static void validate(String text)
    {
        ...
        new ScpConditionParserValidator().visit(parser.root());
