...
public class EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput
{
    ...
    private DescrambleFqdnInput input;
    ...
    public EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput withConfigurationName(String configurationName)
    {
        this.configurationName = configurationName;
        return this;
    }
    ...
    public EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput withConfigETag(String configETag)
    {
        this.configETag = configETag;
        return this;
    }
    ...
    public EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput withContext(String context)
    {
        this.context = context;
        return this;
    }
     ...
     */
    @JsonProperty("input")
    public DescrambleFqdnInput getDescrambleFqdnInput()
    {
        return input;
    }
     ...
     */
    @JsonProperty("input")
    public void setDescrambleFqdnInput(DescrambleFqdnInput input)
    {
        this.input = input;
    }

    public EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput withDescrambleFqdnInput(DescrambleFqdnInput input)
    {
        this.input = input;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput.class.getName())
          .append('@')
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput) == false)
        {
            return false;
        }
        EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput rhs = ((EricssonSeppSeppFunctionNfInstanceFqdnScramblingCommandDescrambleFqdnInput) other);
