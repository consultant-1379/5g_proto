...
public class AllowedNssai1
{
    ...
    public AllowedNssai1 withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public AllowedNssai1 withSst(Integer sst)
    {
        this.sst = sst;
        return this;
    }
    ...
    public AllowedNssai1 withSd(String sd)
    {
        this.sd = sd;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AllowedNssai1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AllowedNssai1) == false)
        {
            return false;
        }
        AllowedNssai1 rhs = ((AllowedNssai1) other);
