...
public class AdditionalId
{
    ...
    public AdditionalId withMcc(String mcc)
    {
        this.mcc = mcc;
        return this;
    }
    ...
    public AdditionalId withMnc(String mnc)
    {
        this.mnc = mnc;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AdditionalId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mcc");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AdditionalId) == false)
        {
            return false;
        }
        AdditionalId rhs = ((AdditionalId) other);
