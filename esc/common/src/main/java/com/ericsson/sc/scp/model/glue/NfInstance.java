...
import com.ericsson.sc.scp.model.NfDiscovery;
import com.ericsson.sc.scp.model.NfManagement;
import com.ericsson.sc.scp.model.NfPeerInfo.OutMessageHandling;
import com.ericsson.sc.scp.model.Nrf;
import com.ericsson.sc.scp.model.NrfGroup;
import com.ericsson.sc.scp.model.NrfService;
...
public class NfInstance
{
    public static class Pool
    {
        ...
        public void update(final List<com.ericsson.sc.scp.model.NfInstance> instances,
    ...
    public static String getSrcSbiNfPeerInfo(final com.ericsson.sc.scp.model.NfInstance instance,
                                             ...
                                             final Nrf nrf)
    {
        ...
        if (instance.getNfPeerInfo() != null && instance.getNfPeerInfo().getOutMessageHandling() == OutMessageHandling.ON)
        {
            ...
            if (fqdn != null)
                b.append("srcscp=SCP-").append(fqdn);
     ...
     * at <code>
     * <ul>
     * <li>slf-lookup-profile/nrf-group-ref</li>
     ...
     */
    private static Set<String> getReferencedNrfGroups(final com.ericsson.sc.scp.model.NfInstance instance)
    {
        final Set<String> referencedNrfGroups = new HashSet<>();

        referencedNrfGroups.addAll(instance.getSlfLookupProfile()
                                           .stream()
                                           .map(SlfLookupProfile::getNrfGroupRef)
                                   ...
                                   final NfProfile override)
    {
        ...
        result.setAssociatedNfPoolRef(override.getAssociatedNfPoolRef().isEmpty() ? base.getAssociatedNfPoolRef() : override.getAssociatedNfPoolRef());
        result.setCapacity(override.getCapacity() == null ? base.getCapacity() : override.getCapacity());
        result.setChfInfo(override.getChfInfo() == null ? base.getChfInfo() : override.getChfInfo());
        ...
        result.setScpInfo(override.getScpInfo() == null ? base.getScpInfo() : override.getScpInfo());
    ...
    public synchronized void update(final com.ericsson.sc.scp.model.NfInstance instance,
                                    final boolean userRelated,
                                    final boolean dnsRelated)
    {
        ...
        if (instance != null)
        {
            instance.getNrfGroup().forEach(g ->
            {
                ...
                if (this.nrfGroups.containsKey(group.getName()))
                {
                    ...
                    final Map<Integer, com.ericsson.sc.scp.model.Nrf> priorities = new HashMap<>();
    ...
    private com.ericsson.sc.nrf.r17.Nrf.Configuration convert(final boolean registrationRequired,
                                                              final com.ericsson.sc.scp.model.Nrf nrf,
                                                              final NrfGroup group,
                                                              final com.ericsson.sc.scp.model.NfInstance instance,
