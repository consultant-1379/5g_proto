...
public class Nrf implements IfNrf
{
    ...
    /**
     * The oauth2 key profile for a specific NRF instance id
     * 
     */
    @JsonProperty("oauth2-key-profile-ref")
    @JsonPropertyDescription("The oauth2 key profile reference for a specific NRF instance id")
    private List<String> oauth2KeyProfileRef = new ArrayList<String>();
    /**
     ...
     */
    @JsonProperty("oauth2-key-profile-ref")
    public List<String> getoauth2KeyProfileRef()
    {
        return oauth2KeyProfileRef;
    }
     ...
     */
    @JsonProperty("oauth2-key-profile-ref")
    public void setoauth2KeyProfileRef(List<String> oauth2KeyProfileRef)
    {
        this.oauth2KeyProfileRef = oauth2KeyProfileRef;
    }

    public Nrf withoauth2KeyProfileRef(List<String> oauth2KeyProfileRef)
    {
        this.oauth2KeyProfileRef = oauth2KeyProfileRef;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(',');
        sb.append("oauth2KeyProfileRef");
        sb.append('=');
        sb.append(((this.oauth2KeyProfileRef == null) ? "<null>" : this.oauth2KeyProfileRef));
        sb.append(',');
        sb.append("priority");
        sb.append('=');
    ...
    public int hashCode()
    {
        ...
        result = ((result * 31) + ((this.oauth2KeyProfileRef == null) ? 0 : this.oauth2KeyProfileRef.hashCode()));
    ...
    public boolean equals(Object other)
    {
        ...
        return (((((((((((this.maxRetries == rhs.maxRetries) || ((this.maxRetries != null) && this.maxRetries.equals(rhs.maxRetries)))
                    ...
                    && ((this.oauth2KeyProfileRef == rhs.oauth2KeyProfileRef)
                        || ((this.oauth2KeyProfileRef != null) && this.oauth2KeyProfileRef.equals(rhs.oauth2KeyProfileRef))))
