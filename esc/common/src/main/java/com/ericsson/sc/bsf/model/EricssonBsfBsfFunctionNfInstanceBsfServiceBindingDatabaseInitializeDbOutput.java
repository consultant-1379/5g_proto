...
public class EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput
{
    ...
    public EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput withEricssonBsfInfo(String ericssonBsfInfo)
    {
        this.ericssonBsfInfo = ericssonBsfInfo;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput.class.getName())
          .append('@')
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput) == false)
        {
            return false;
        }
        EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput rhs = ((EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbOutput) other);
