...
public class ReceivedPlmnId
{
    ...
    public ReceivedPlmnId withMcc(String mcc)
    {
        this.mcc = mcc;
        return this;
    }
    ...
    public ReceivedPlmnId withMnc(String mnc)
    {
        this.mnc = mnc;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ReceivedPlmnId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mcc");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ReceivedPlmnId) == false)
        {
            return false;
        }
        ReceivedPlmnId rhs = ((ReceivedPlmnId) other);
