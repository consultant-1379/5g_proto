...
public class AdditionalAllowedOperation
{
    ...
    public AdditionalAllowedOperation withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public AdditionalAllowedOperation withServiceName(List<String> serviceName)
    {
        this.serviceName = serviceName;
        return this;
    }
    ...
    public AdditionalAllowedOperation withServiceVersion(List<String> serviceVersion)
    {
        this.serviceVersion = serviceVersion;
        return this;
    }
    ...
    public AdditionalAllowedOperation withNotificationMessage(Boolean notificationMessage)
    {
        this.notificationMessage = notificationMessage;
        return this;
    }
    ...
    public AdditionalAllowedOperation withHttpMethod(List<HttpMethod> httpMethod)
    {
        this.httpMethod = httpMethod;
        return this;
    }
    ...
    public AdditionalAllowedOperation withResource(List<String> resource)
    {
        this.resource = resource;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AdditionalAllowedOperation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AdditionalAllowedOperation) == false)
        {
            return false;
        }
        AdditionalAllowedOperation rhs = ((AdditionalAllowedOperation) other);
