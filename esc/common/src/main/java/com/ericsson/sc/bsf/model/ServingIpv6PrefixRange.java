...
public class ServingIpv6PrefixRange
{
    ...
    public ServingIpv6PrefixRange withIpv6PrefixEnd(String ipv6PrefixEnd)
    {
        this.ipv6PrefixEnd = ipv6PrefixEnd;
        return this;
    }
    ...
    public ServingIpv6PrefixRange withIpv6PrefixStart(String ipv6PrefixStart)
    {
        this.ipv6PrefixStart = ipv6PrefixStart;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ServingIpv6PrefixRange.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ServingIpv6PrefixRange) == false)
        {
            return false;
        }
        ServingIpv6PrefixRange rhs = ((ServingIpv6PrefixRange) other);
