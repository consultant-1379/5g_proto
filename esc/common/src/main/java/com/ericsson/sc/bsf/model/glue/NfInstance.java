...
package com.ericsson.sc.bsf.model.glue;
...
public class NfInstance
{
    public static class Pool
    {
        ...
        public void update(final List<com.ericsson.sc.bsf.model.NfInstance> instances,
    ...
    public static String getSrcSbiNfPeerInfo(final com.ericsson.sc.bsf.model.NfInstance instance,
                                             ...
                                             final Nrf nrf)
    {
        ...
        if (instance.getNfPeerInfo() != null && instance.getNfPeerInfo().getOutMessageHandling() == OutMessageHandling.ON)
        {
            ...
            if (instance.getNfInstanceId() != null)
                b.append("srcinst=").append(instance.getNfInstanceId());
     ...
     */
    private static Set<String> getReferencedNrfGroups(final com.ericsson.sc.bsf.model.NfInstance instance)
    {
                                   ...
                                   final NfProfile override)
    {
        ...
        result.setBsfInfo(override.getBsfInfo() == null ? base.getBsfInfo() : override.getBsfInfo());
    ...
    public synchronized void update(final com.ericsson.sc.bsf.model.NfInstance instance,
                                    final boolean userRelated,
                                    final boolean dnsRelated)
    {
        ...
        if (instance != null)
        {
            instance.getNrfGroup().forEach(g ->
            {
                ...
                if (this.nrfGroups.containsKey(group.getName()))
                {
                    ...
                    final Map<Integer, com.ericsson.sc.bsf.model.Nrf> priorities = new HashMap<>();
    ...
    private com.ericsson.sc.nrf.r17.Nrf.Configuration convert(final boolean registrationRequired,
                                                              final com.ericsson.sc.bsf.model.Nrf nrf,
                                                              final NrfGroup group,
                                                              final com.ericsson.sc.bsf.model.NfInstance instance,
