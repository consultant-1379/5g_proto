...
public class ReplaceValue
{
    ...
    public ReplaceValue withValue(String value)
    {
        this.value = value;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ReplaceValue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ReplaceValue) == false)
        {
            return false;
        }
        ReplaceValue rhs = ((ReplaceValue) other);
