...
public class ServiceAddress implements IfServiceAddress
{
    ...
    /**
     * IPv4 address of the BSF service
     * 
     */
    @JsonProperty("ipv4-address")
    @JsonPropertyDescription("IPv4 address of the BSF service")
    private String ipv4Address;
    /**
     * IPv6 address of the BSF service
     * 
     */
    @JsonProperty("ipv6-address")
    @JsonPropertyDescription("IPv6 address of the BSF service")
