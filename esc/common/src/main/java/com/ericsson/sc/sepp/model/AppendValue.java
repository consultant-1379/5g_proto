...
public class AppendValue
{
    ...
    public AppendValue withValue(String value)
    {
        this.value = value;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AppendValue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AppendValue) == false)
        {
            return false;
        }
        AppendValue rhs = ((AppendValue) other);
