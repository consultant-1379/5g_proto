...
public class RequestMessage
{
    ...
    public RequestMessage withMessageDataRef(List<String> messageDataRef)
    {
        this.messageDataRef = messageDataRef;
        return this;
    }
    ...
    public RequestMessage withSearchInQueryParameter(List<SearchInQueryParameter> searchInQueryParameter)
    {
        this.searchInQueryParameter = searchInQueryParameter;
        return this;
    }
    ...
    public RequestMessage withSearchInHeader(List<SearchInHeader> searchInHeader)
    {
        this.searchInHeader = searchInHeader;
        return this;
    }
    ...
    public RequestMessage withSearchInMessageBody(List<SearchInMessageBody> searchInMessageBody)
    {
        this.searchInMessageBody = searchInMessageBody;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(RequestMessage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
