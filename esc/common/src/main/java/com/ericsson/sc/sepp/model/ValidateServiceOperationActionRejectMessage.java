...
public class ValidateServiceOperationActionRejectMessage implements IfActionRejectMessageBase
{
    ...
    private ValidateServiceOperationActionRejectMessage.Format format = ValidateServiceOperationActionRejectMessage.Format.fromValue("json");
    ...
    public ValidateServiceOperationActionRejectMessage withStatus(Integer status)
    {
        this.status = status;
        return this;
    }
    ...
    public ValidateServiceOperationActionRejectMessage withTitle(String title)
    {
        this.title = title;
        return this;
    }
    ...
    public ValidateServiceOperationActionRejectMessage withCause(String cause)
    {
        this.cause = cause;
        return this;
    }
    ...
    public ValidateServiceOperationActionRejectMessage withDetail(String detail)
    {
        this.detail = detail;
        return this;
    }
     ...
     */
    @JsonProperty("format")
    public ValidateServiceOperationActionRejectMessage.Format getFormat()
    {
        return format;
    }
     ...
     */
    @JsonProperty("format")
    public void setFormat(ValidateServiceOperationActionRejectMessage.Format format)
    {
        this.format = format;
    }

    public ValidateServiceOperationActionRejectMessage withFormat(ValidateServiceOperationActionRejectMessage.Format format)
    {
        this.format = format;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ValidateServiceOperationActionRejectMessage.class.getName())
          .append('@')
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ValidateServiceOperationActionRejectMessage) == false)
        {
            return false;
        }
        ValidateServiceOperationActionRejectMessage rhs = ((ValidateServiceOperationActionRejectMessage) other);
    ...
    public enum Format
    {
        ...
        private final static Map<String, ValidateServiceOperationActionRejectMessage.Format> CONSTANTS = new HashMap<String, ValidateServiceOperationActionRejectMessage.Format>();

        static
        {
            for (ValidateServiceOperationActionRejectMessage.Format c : values())
            {
        ...
        @JsonCreator
        public static ValidateServiceOperationActionRejectMessage.Format fromValue(String value)
        {
            ValidateServiceOperationActionRejectMessage.Format constant = CONSTANTS.get(value);
            if (constant == null)
            {
