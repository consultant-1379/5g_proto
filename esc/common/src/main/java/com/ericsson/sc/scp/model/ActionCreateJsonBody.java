...
public class ActionCreateJsonBody
{
    ...
    public ActionCreateJsonBody withJsonBody(String jsonBody)
    {
        this.jsonBody = jsonBody;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ActionCreateJsonBody.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("jsonBody");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ActionCreateJsonBody) == false)
        {
            return false;
        }
        ActionCreateJsonBody rhs = ((ActionCreateJsonBody) other);
