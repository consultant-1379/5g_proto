...
public class NfPoolDiscovery implements IfNfPoolDiscovery
{
     ...
     * discovered-nf-instance of this nf-pool
     * 
     */
    @JsonProperty("nrf-query")
    @JsonPropertyDescription("NRF queries used to discover NF instances that then get stored in attribute discovered-nf-instance of this nf-pool")
