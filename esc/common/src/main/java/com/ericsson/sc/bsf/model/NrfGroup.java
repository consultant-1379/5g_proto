...
@JsonPropertyOrder({ "name", "nf-instance-id", "dns-profile-ref", "nf-profile-ref", "nrf" })
public class NrfGroup implements IfNrfGroup
{

    /**
     * Name uniquely identifying the NRF group (Required)
     * 
     */
    @JsonProperty("name")
    @JsonPropertyDescription("Name uniquely identifying the NRF group")
    private String name;
    /**
     * ID uniquely identifying the NF Profile of this BSF instance, given per NRF
     * Group.
     * 
     */
    @JsonProperty("nf-instance-id")
    @JsonPropertyDescription("ID uniquely identifying the NF Profile of this BSF instance, given per NRF Group.")
