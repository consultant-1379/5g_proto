...
public class AddFromVarName__1
{
    ...
    private AddFromVarName__1.IfPathNotExists ifPathNotExists = AddFromVarName__1.IfPathNotExists.fromValue("create");
    /**
    ...
    private AddFromVarName__1.IfElementExists ifElementExists = AddFromVarName__1.IfElementExists.fromValue("no-action");
    /**
     ...
     */
    @JsonProperty("if-path-not-exists")
    public AddFromVarName__1.IfPathNotExists getIfPathNotExists()
    {
     ...
     */
    @JsonProperty("if-path-not-exists")
    public void setIfPathNotExists(AddFromVarName__1.IfPathNotExists ifPathNotExists)
    {
        this.ifPathNotExists = ifPathNotExists;
    }

    public AddFromVarName__1 withIfPathNotExists(AddFromVarName__1.IfPathNotExists ifPathNotExists)
    {
        this.ifPathNotExists = ifPathNotExists;
        return this;
    }
     ...
     */
    @JsonProperty("if-element-exists")
    public AddFromVarName__1.IfElementExists getIfElementExists()
    {
     ...
     */
    @JsonProperty("if-element-exists")
    public void setIfElementExists(AddFromVarName__1.IfElementExists ifElementExists)
    {
        this.ifElementExists = ifElementExists;
    }

    public AddFromVarName__1 withIfElementExists(AddFromVarName__1.IfElementExists ifElementExists)
    {
        this.ifElementExists = ifElementExists;
        return this;
    }
    ...
    public AddFromVarName__1 withVariable(String variable)
    {
        this.variable = variable;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AddFromVarName__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AddFromVarName__1) == false)
        {
            return false;
        }
        AddFromVarName__1 rhs = ((AddFromVarName__1) other);
    ...
    public enum IfElementExists
    {
        ...
        private final static Map<String, AddFromVarName__1.IfElementExists> CONSTANTS = new HashMap<String, AddFromVarName__1.IfElementExists>();

        static
        {
            for (AddFromVarName__1.IfElementExists c : values())
            {
        ...
        @JsonCreator
        public static AddFromVarName__1.IfElementExists fromValue(String value)
        {
            AddFromVarName__1.IfElementExists constant = CONSTANTS.get(value);
            if (constant == null)
            {
    ...
    public enum IfPathNotExists
    {
        ...
        private final String value;
        private final static Map<String, AddFromVarName__1.IfPathNotExists> CONSTANTS = new HashMap<String, AddFromVarName__1.IfPathNotExists>();

        static
        {
            for (AddFromVarName__1.IfPathNotExists c : values())
            {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static AddFromVarName__1.IfPathNotExists fromValue(String value)
        {
            AddFromVarName__1.IfPathNotExists constant = CONSTANTS.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
