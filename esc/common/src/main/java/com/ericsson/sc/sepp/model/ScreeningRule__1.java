...
public class ScreeningRule__1
{
     ...
     * incoming responses as stored in message-data, and determines whether the
     * screening-rule shall be executed. If no condition is defined, the
     * screening-rule is always executed (Required)
     * 
     */
    @JsonProperty("condition")
    @JsonPropertyDescription("A logical expression which is evaluated using the collected data from incoming responses as stored in message-data, and determines whether the screening-rule shall be executed. If no condition is defined, the screening-rule is always executed")
    ...
    private List<ScreeningAction__1> screeningAction = new ArrayList<ScreeningAction__1>();
    ...
    public ScreeningRule__1 withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public ScreeningRule__1 withCondition(String condition)
    {
        this.condition = condition;
        return this;
    }
     ...
     */
    @JsonProperty("screening-action")
    public List<ScreeningAction__1> getScreeningAction()
    {
     ...
     */
    @JsonProperty("screening-action")
    public void setScreeningAction(List<ScreeningAction__1> screeningAction)
    {
        this.screeningAction = screeningAction;
    }

    public ScreeningRule__1 withScreeningAction(List<ScreeningAction__1> screeningAction)
    {
        this.screeningAction = screeningAction;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ScreeningRule__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ScreeningRule__1) == false)
        {
            return false;
        }
        ScreeningRule__1 rhs = ((ScreeningRule__1) other);
