...
@JsonPropertyOrder({ "nf-instance-id", "nf-status", "discovered-nf-service", "name", "nf-type", "locality", "nf-set-id", "scp-domain" })
public class DiscoveredNfInstance implements IfDiscoveredNfInstance, Comparable<DiscoveredNfInstance>
{
     ...
     * 
     */
    @JsonProperty("discovered-nf-service")
    @JsonPropertyDescription("The service for which an NF has registered")
    private List<DiscoveredNfService> discoveredNfService = new ArrayList<DiscoveredNfService>();
    /**
    ...
    public DiscoveredNfInstance withNfInstanceId(String nfInstanceId)
    {
        this.nfInstanceId = nfInstanceId;
        return this;
    }
    ...
    public DiscoveredNfInstance withNfStatus(NfStatus nfStatus)
    {
        this.nfStatus = nfStatus;
        return this;
    }
     ...
     */
    @JsonProperty("discovered-nf-service")
    public List<DiscoveredNfService> getDiscoveredNfService()
    {
        return discoveredNfService;
    }
     ...
     */
    @JsonProperty("discovered-nf-service")
    public void setDiscoveredNfService(List<DiscoveredNfService> discoveredNfService)
    {
        this.discoveredNfService = discoveredNfService;
    }

    public DiscoveredNfInstance withDiscoveredNfService(List<DiscoveredNfService> discoveredNfService)
    {
        this.discoveredNfService = discoveredNfService;
        return this;
    }
    ...
    public DiscoveredNfInstance withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public DiscoveredNfInstance withNfType(String nfType)
    {
        this.nfType = nfType;
        return this;
    }
    ...
    public DiscoveredNfInstance withLocality(String locality)
    {
        this.locality = locality;
        return this;
    }
    ...
    public DiscoveredNfInstance withNfSetId(List<String> nfSetId)
    {
        this.nfSetId = nfSetId;
        return this;
    }
    ...
    public DiscoveredNfInstance withScpDomain(List<String> scpDomain)
    {
        this.scpDomain = scpDomain;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(DiscoveredNfInstance.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("discoveredNfService");
        sb.append('=');
        sb.append(((this.discoveredNfService == null) ? "<null>" : this.discoveredNfService));
        sb.append(',');
        sb.append("name");
        sb.append('=');
    ...
    @JsonIgnore
    @Override
    public int compareTo(DiscoveredNfInstance o)
    {
    ...
    public int hashCode()
    {
        ...
        result = ((result * 31) + ((this.discoveredNfService == null) ? 0 : this.discoveredNfService.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof DiscoveredNfInstance) == false)
        {
            return false;
        }
        DiscoveredNfInstance rhs = ((DiscoveredNfInstance) other);
        return (((((((((this.scpDomain == rhs.scpDomain) || ((this.scpDomain != null) && this.scpDomain.equals(rhs.scpDomain)))
                ...
                && ((this.discoveredNfService == rhs.discoveredNfService)
                    || ((this.discoveredNfService != null) && this.discoveredNfService.equals(rhs.discoveredNfService))));
    }
