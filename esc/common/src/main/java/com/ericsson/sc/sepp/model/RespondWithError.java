...
public class RespondWithError
{
    ...
    private RespondWithError.Format format = RespondWithError.Format.fromValue("json");
    ...
    public RespondWithError withStatus(Integer status)
    {
        this.status = status;
        return this;
    }
    ...
    public RespondWithError withTitle(String title)
    {
        this.title = title;
        return this;
    }
    ...
    public RespondWithError withCause(String cause)
    {
        this.cause = cause;
        return this;
    }
    ...
    public RespondWithError withDetail(String detail)
    {
        this.detail = detail;
        return this;
    }
     ...
     */
    @JsonProperty("format")
    public RespondWithError.Format getFormat()
    {
        return format;
    }
     ...
     */
    @JsonProperty("format")
    public void setFormat(RespondWithError.Format format)
    {
        this.format = format;
    }

    public RespondWithError withFormat(RespondWithError.Format format)
    {
        this.format = format;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(RespondWithError.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof RespondWithError) == false)
        {
            return false;
        }
        RespondWithError rhs = ((RespondWithError) other);
    ...
    public enum Format
    {
        ...
        private final static Map<String, RespondWithError.Format> CONSTANTS = new HashMap<String, RespondWithError.Format>();

        static
        {
            for (RespondWithError.Format c : values())
            {
        ...
        @JsonCreator
        public static RespondWithError.Format fromValue(String value)
        {
            RespondWithError.Format constant = CONSTANTS.get(value);
            if (constant == null)
            {
