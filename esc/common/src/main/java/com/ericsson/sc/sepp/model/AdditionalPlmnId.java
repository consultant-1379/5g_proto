...
public class AdditionalPlmnId
{
    ...
    public AdditionalPlmnId withMcc(String mcc)
    {
        this.mcc = mcc;
        return this;
    }
    ...
    public AdditionalPlmnId withMnc(String mnc)
    {
        this.mnc = mnc;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AdditionalPlmnId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mcc");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AdditionalPlmnId) == false)
        {
            return false;
        }
        AdditionalPlmnId rhs = ((AdditionalPlmnId) other);
