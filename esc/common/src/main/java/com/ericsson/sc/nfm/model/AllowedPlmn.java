...
public class AllowedPlmn
{
    ...
    public AllowedPlmn withMcc(String mcc)
    {
        this.mcc = mcc;
        return this;
    }
    ...
    public AllowedPlmn withMnc(String mnc)
    {
        this.mnc = mnc;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AllowedPlmn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mcc");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AllowedPlmn) == false)
        {
            return false;
        }
        AllowedPlmn rhs = ((AllowedPlmn) other);
