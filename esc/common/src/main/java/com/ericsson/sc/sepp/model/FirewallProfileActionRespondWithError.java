...
public class FirewallProfileActionRespondWithError
{
    ...
    private FirewallProfileActionRespondWithError.Format format = FirewallProfileActionRespondWithError.Format.fromValue("json");
    ...
    public FirewallProfileActionRespondWithError withStatus(Integer status)
    {
        this.status = status;
        return this;
    }
    ...
    public FirewallProfileActionRespondWithError withTitle(String title)
    {
        this.title = title;
        return this;
    }
    ...
    public FirewallProfileActionRespondWithError withCause(String cause)
    {
        this.cause = cause;
        return this;
    }
    ...
    public FirewallProfileActionRespondWithError withDetail(String detail)
    {
        this.detail = detail;
        return this;
    }
     ...
     */
    @JsonProperty("format")
    public FirewallProfileActionRespondWithError.Format getFormat()
    {
        return format;
    }
     ...
     */
    @JsonProperty("format")
    public void setFormat(FirewallProfileActionRespondWithError.Format format)
    {
        this.format = format;
    }

    public FirewallProfileActionRespondWithError withFormat(FirewallProfileActionRespondWithError.Format format)
    {
        this.format = format;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(FirewallProfileActionRespondWithError.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof FirewallProfileActionRespondWithError) == false)
        {
            return false;
        }
        FirewallProfileActionRespondWithError rhs = ((FirewallProfileActionRespondWithError) other);
    ...
    public enum Format
    {
        ...
        private final static Map<String, FirewallProfileActionRespondWithError.Format> CONSTANTS = new HashMap<String, FirewallProfileActionRespondWithError.Format>();

        static
        {
            for (FirewallProfileActionRespondWithError.Format c : values())
            {
        ...
        @JsonCreator
        public static FirewallProfileActionRespondWithError.Format fromValue(String value)
        {
            FirewallProfileActionRespondWithError.Format constant = CONSTANTS.get(value);
            if (constant == null)
            {
