...
public class Snssai1
{
    ...
    public Snssai1 withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public Snssai1 withSst(Integer sst)
    {
        this.sst = sst;
        return this;
    }
    ...
    public Snssai1 withSd(String sd)
    {
        this.sd = sd;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(Snssai1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof Snssai1) == false)
        {
            return false;
        }
        Snssai1 rhs = ((Snssai1) other);
