...
public class NrfService implements IfNrfService
{
    ...
    /**
     * Triggers the registration of this NF instance towards NRF and the usage of
     * the Nnrf_NfManagement service
     * 
     */
    @JsonProperty("nf-management")
    @JsonPropertyDescription("Triggers the registration of this NF instance towards NRF and the usage of the Nnrf_NfManagement service")
    ...
    @JsonPropertyDescription("Enables the usage of the Nnrf_NfDiscovery service")
