...
@JsonPropertyOrder({ "max-leaves", "report-event", "action-reject-message", "action-drop-message", "action-forward-unmodified-message" })
public class RequestValidateMessageJsonBodyLeaves implements IfValidationChecks
{
    ...
    public RequestValidateMessageJsonBodyLeaves withMaxLeaves(Integer maxLeaves)
    {
        this.maxLeaves = maxLeaves;
        return this;
    }
    ...
    public RequestValidateMessageJsonBodyLeaves withReportEvent(Boolean reportEvent)
    {
        this.reportEvent = reportEvent;
        return this;
    }
    ...
    public RequestValidateMessageJsonBodyLeaves withActionRejectMessage(FirewallProfileActionRejectMessage actionRejectMessage)
    {
        this.actionRejectMessage = actionRejectMessage;
        return this;
    }
    ...
    public RequestValidateMessageJsonBodyLeaves withActionDropMessage(FirewallProfileActionDropMessage actionDropMessage)
    {
        this.actionDropMessage = actionDropMessage;
        return this;
    }
    ...
    public RequestValidateMessageJsonBodyLeaves withActionForwardUnmodifiedMessage(FirewallProfileActionForwardUnmodifiedMessage actionForwardUnmodifiedMessage)
    {
        this.actionForwardUnmodifiedMessage = actionForwardUnmodifiedMessage;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(RequestValidateMessageJsonBodyLeaves.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("maxLeaves");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof RequestValidateMessageJsonBodyLeaves) == false)
        {
            return false;
        }
        RequestValidateMessageJsonBodyLeaves rhs = ((RequestValidateMessageJsonBodyLeaves) other);
