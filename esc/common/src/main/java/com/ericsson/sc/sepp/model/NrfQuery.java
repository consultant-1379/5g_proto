...
public class NrfQuery
{
    ...
    private String requesterNfType = "SEPP";
    /**
    ...
    @JsonPropertyDescription("Custom query parameter used for parameters not covered by non-custom attributes in nrf-query. Query parameter names already covered may not be used. Apart from this, possible name and value are according to TS 29.510")
