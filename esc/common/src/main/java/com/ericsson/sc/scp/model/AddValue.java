...
public class AddValue
{
    ...
    private AddValue.IfPathNotExists ifPathNotExists = AddValue.IfPathNotExists.fromValue("create");
    /**
    ...
    private AddValue.IfElementExists ifElementExists = AddValue.IfElementExists.fromValue("no-action");
    ...
    public AddValue withValue(String value)
    {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("if-path-not-exists")
    public AddValue.IfPathNotExists getIfPathNotExists()
    {
     ...
     */
    @JsonProperty("if-path-not-exists")
    public void setIfPathNotExists(AddValue.IfPathNotExists ifPathNotExists)
    {
        this.ifPathNotExists = ifPathNotExists;
    }

    public AddValue withIfPathNotExists(AddValue.IfPathNotExists ifPathNotExists)
    {
        this.ifPathNotExists = ifPathNotExists;
        return this;
    }
     ...
     */
    @JsonProperty("if-element-exists")
    public AddValue.IfElementExists getIfElementExists()
    {
     ...
     */
    @JsonProperty("if-element-exists")
    public void setIfElementExists(AddValue.IfElementExists ifElementExists)
    {
        this.ifElementExists = ifElementExists;
    }

    public AddValue withIfElementExists(AddValue.IfElementExists ifElementExists)
    {
        this.ifElementExists = ifElementExists;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(AddValue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof AddValue) == false)
        {
            return false;
        }
        AddValue rhs = ((AddValue) other);
    ...
    public enum IfElementExists
    {
        ...
        private final static Map<String, AddValue.IfElementExists> CONSTANTS = new HashMap<String, AddValue.IfElementExists>();

        static
        {
            for (AddValue.IfElementExists c : values())
            {
        ...
        @JsonCreator
        public static AddValue.IfElementExists fromValue(String value)
        {
            AddValue.IfElementExists constant = CONSTANTS.get(value);
            if (constant == null)
            {
    ...
    public enum IfPathNotExists
    {
        ...
        private final String value;
        private final static Map<String, AddValue.IfPathNotExists> CONSTANTS = new HashMap<String, AddValue.IfPathNotExists>();

        static
        {
            for (AddValue.IfPathNotExists c : values())
            {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static AddValue.IfPathNotExists fromValue(String value)
        {
            AddValue.IfPathNotExists constant = CONSTANTS.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
