...
public class ValidateServiceOperation
{
    ...
    private ValidateServiceOperationActionRejectMessage actionRejectMessage;
    /**
    ...
    public ValidateServiceOperation withAdditionalAllowedOperations(List<AdditionalAllowedOperation> additionalAllowedOperations)
    {
        this.additionalAllowedOperations = additionalAllowedOperations;
        return this;
    }
    ...
    public ValidateServiceOperation withRemovedDefaultOperations(List<RemovedDefaultOperation> removedDefaultOperations)
    {
        this.removedDefaultOperations = removedDefaultOperations;
        return this;
    }
    ...
    public ValidateServiceOperation withReportEvent(Boolean reportEvent)
    {
        this.reportEvent = reportEvent;
        return this;
    }
     ...
     */
    @JsonProperty("action-reject-message")
    public ValidateServiceOperationActionRejectMessage getActionRejectMessage()
    {
     ...
     */
    @JsonProperty("action-reject-message")
    public void setActionRejectMessage(ValidateServiceOperationActionRejectMessage actionRejectMessage)
    {
        this.actionRejectMessage = actionRejectMessage;
    }

    public ValidateServiceOperation withActionRejectMessage(ValidateServiceOperationActionRejectMessage actionRejectMessage)
    {
        this.actionRejectMessage = actionRejectMessage;
        return this;
    }
    ...
    public ValidateServiceOperation withActionDropMessage(FirewallProfileActionDropMessage actionDropMessage)
    {
        this.actionDropMessage = actionDropMessage;
        return this;
    }
    ...
    public ValidateServiceOperation withActionForwardUnmodifiedMessage(FirewallProfileActionForwardUnmodifiedMessage actionForwardUnmodifiedMessage)
    {
        this.actionForwardUnmodifiedMessage = actionForwardUnmodifiedMessage;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ValidateServiceOperation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ValidateServiceOperation) == false)
        {
            return false;
        }
        ValidateServiceOperation rhs = ((ValidateServiceOperation) other);
