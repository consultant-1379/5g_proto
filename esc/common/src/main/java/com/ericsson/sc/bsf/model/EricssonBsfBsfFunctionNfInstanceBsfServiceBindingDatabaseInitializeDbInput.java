...
public class EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput
{
    ...
    public EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput withConfigurationName(String configurationName)
    {
        this.configurationName = configurationName;
        return this;
    }
    ...
    public EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput withConfigETag(String configETag)
    {
        this.configETag = configETag;
        return this;
    }
    ...
    public EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput withContext(String context)
    {
        this.context = context;
        return this;
    }
    ...
    public EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput withInput(Input input)
    {
        this.input = input;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput.class.getName())
          .append('@')
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput) == false)
        {
            return false;
        }
        EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput rhs = ((EricssonBsfBsfFunctionNfInstanceBsfServiceBindingDatabaseInitializeDbInput) other);
