...
public class RemotePlmn
{
    ...
    public RemotePlmn withMcc(String mcc)
    {
        this.mcc = mcc;
        return this;
    }
    ...
    public RemotePlmn withMnc(String mnc)
    {
        this.mnc = mnc;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(RemotePlmn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mcc");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof RemotePlmn) == false)
        {
            return false;
        }
        RemotePlmn rhs = ((RemotePlmn) other);
