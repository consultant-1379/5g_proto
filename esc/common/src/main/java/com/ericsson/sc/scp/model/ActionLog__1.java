...
public class ActionLog__1 implements IfActionLogBase
{
    ...
    private ActionLog__1.LogLevel logLevel = ActionLog__1.LogLevel.fromValue("debug");
    ...
    public ActionLog__1 withText(String text)
    {
        this.text = text;
        return this;
    }
    ...
    public ActionLog__1 withMaxLogMessageLength(Integer maxLogMessageLength)
    {
        this.maxLogMessageLength = maxLogMessageLength;
        return this;
    }
     ...
     */
    @JsonProperty("log-level")
    public ActionLog__1.LogLevel getLogLevel()
    {
        return logLevel;
    }
     ...
     */
    @JsonProperty("log-level")
    public void setLogLevel(ActionLog__1.LogLevel logLevel)
    {
        this.logLevel = logLevel;
    }

    public ActionLog__1 withLogLevel(ActionLog__1.LogLevel logLevel)
    {
        this.logLevel = logLevel;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(ActionLog__1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof ActionLog__1) == false)
        {
            return false;
        }
        ActionLog__1 rhs = ((ActionLog__1) other);
    ...
    public enum LogLevel
    {
        ...
        private final static Map<String, ActionLog__1.LogLevel> CONSTANTS = new HashMap<String, ActionLog__1.LogLevel>();

        static
        {
            for (ActionLog__1.LogLevel c : values())
            {
        ...
        @JsonCreator
        public static ActionLog__1.LogLevel fromValue(String value)
        {
            ActionLog__1.LogLevel constant = CONSTANTS.get(value);
            if (constant == null)
            {
