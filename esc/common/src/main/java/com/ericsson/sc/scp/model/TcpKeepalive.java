...
public class TcpKeepalive implements IfTcpKeepalive
{
    ...
    public TcpKeepalive withProbes(Integer probes)
    {
        this.probes = probes;
        return this;
    }
    ...
    public TcpKeepalive withTime(Integer time)
    {
        this.time = time;
        return this;
    }
    ...
    public TcpKeepalive withInterval(Integer interval)
    {
        this.interval = interval;
        return this;
    }
    ...
    public String toString()
    {
        ...
        sb.append(TcpKeepalive.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("probes");
        sb.append('=');
    ...
    public boolean equals(Object other)
    {
        ...
        if ((other instanceof TcpKeepalive) == false)
        {
            return false;
        }
        TcpKeepalive rhs = ((TcpKeepalive) other);
