...
public class NfPool implements IfNfPool
{
     ...
     * seconds time interval, that lead to raising the alarm: SCP, NF Instance
     * Unavailable
     * 
     */
    @JsonProperty("threshold-for-nf-unavailable-alarm")
    @JsonPropertyDescription("Threshold for the integer of 5xx errors and timeouts received within 15 seconds time interval, that lead to raising the alarm: SCP, NF Instance Unavailable")
     ...
     * NF pool. Applicable only to dynamically discovered NF instances
     * 
     */
    @JsonProperty("nf-match-condition")
    @JsonPropertyDescription("Only the NF instances that satisfy the nf-match-condition are included in the NF pool. Applicable only to dynamically discovered NF instances")
    ...
    public boolean equals(Object other)
    {
        ...
        return ((((((((((((((((((((this.nfPoolDiscovery == rhs.nfPoolDiscovery)
                              ...
                              && ((this.priorityGroup == rhs.priorityGroup) || ((this.priorityGroup != null) && this.priorityGroup.equals(rhs.priorityGroup))))
