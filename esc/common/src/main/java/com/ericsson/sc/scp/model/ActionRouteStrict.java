...
public class ActionRouteStrict implements IfActionRouteBase, IfActionRouteTarget
{
    ...
    /**
     * Selected attributes value to preserve in case of indirect routing
     * 
     */
    @JsonProperty("preserve-if-indirect-routing")
    @JsonPropertyDescription("Selected attributes value to preserve in case of indirect routing")
    ...
    public ActionRouteStrict withKeepAuthorityHeader(KeepAuthorityHeader keepAuthorityHeader)
    {
        this.keepAuthorityHeader = keepAuthorityHeader;
        return this;
    }
    ...
    public ActionRouteStrict withPreserveIfIndirectRouting(PreserveIfIndirectRouting preserveIfIndirectRouting)
    {
        this.preserveIfIndirectRouting = preserveIfIndirectRouting;
        return this;
    }
