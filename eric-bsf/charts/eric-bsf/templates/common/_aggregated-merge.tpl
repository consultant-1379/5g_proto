...
{{- define "eric-bsf.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-bsf.mergeAnnotations" -}}
  {{- include "eric-bsf.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-bsf.mergeLabels" -}}
  {{- include "eric-bsf.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
