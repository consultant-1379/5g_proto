...
*/}}
{{- define "eric-bsf.wcdbcd.hostname" -}}
{{- $wcdbcdHostName := default "eric-bsf-wcdb-cd" .Values.adp.data.wcdbcd.hostname -}}
...
*/}}
{{- define "eric-bsf.wcdbcd.datacenter" -}}
{{- $datacenter := default "datacenter1" .Values.cassandra.datacenter -}}
{{- toYaml $datacenter -}}
{{- end -}}
