...
@JsonPropertyOrder({ "id", "configName", "event", "updateNotificationFormat", "callback", "leaseSeconds" })
public class SubscriptionGet
{
    ...
    /**
     * The subscribed events (Required)
     *
     */
    @JsonProperty("event")
     ...
     * 'patch' means a JSON Patch notification is sent with the changes. (Required)
     *
     */
    ...
    /**
     * The callback URI for receiving notifications (Required)
     *
     */
    ...
    /**
     * The number of seconds the subscription is valid (Required)
     *
     */
