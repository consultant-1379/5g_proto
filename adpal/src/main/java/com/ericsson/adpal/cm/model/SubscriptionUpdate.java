...
@JsonPropertyOrder({ "configName", "event", "updateNotificationFormat", "leaseSeconds", "callback", "serverName" })
public class SubscriptionUpdate
{

    /**
     * The configuration name, use '*' to subscribe on all configurations (Required)
     *
     */
    ...
    /**
     * The configuration update notification format. This is only relevant if a
     * configUpdated event is specified. 'none' means no configuration data is sent
     * in the notification, 'full' means the complete configuration data is sent,
     * 'patch' means a JSON Patch notification is sent with the changes.
     *
     */
    ...
    /**
     * The callback URI for receiving notifications. HTTP Notifications will be
     * POSTed to the callback URI and follow the Notification schema. A Kafka URI is
     * of the format: kafka:<topic name>[:<message key>]. The Notification will be
     * delivered to specified topic and using the optional message key for the
     * Notification. The message key should be used if distribution over several
     * partitions are needed. (Required)
     *
     */
    ...
    /**
     * The server name to be used with TLS/Server Name Indication (SNI), if the
     * callback URI includes an IP address. Mandatory for IP address based
     * subscriptions if mTLS is enforced. (Required for MTLS)
     *
     */
    @JsonProperty("serverName")
    @JsonPropertyDescription("The server name to be used with TLS/Server Name Indication (SNI), if the callback URI includes an IP address. Mandatory for IP address based subscriptions if mTLS is enforced.")
    ...
    public SubscriptionUpdate withServerName(String serverName)
    {
        this.serverName = serverName;
        return this;
    }
