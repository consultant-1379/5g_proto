...
{{- define "eric-sc-monitor.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sc-monitor.mergeAnnotations" -}}
  {{- include "eric-sc-monitor.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sc-monitor.mergeLabels" -}}
  {{- include "eric-sc-monitor.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
