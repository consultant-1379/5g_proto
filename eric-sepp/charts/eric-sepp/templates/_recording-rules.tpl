{{- define "eric-sepp.recording-rules" }}
groups:
- name: sepp_metrics
  interval: 15s
  rules:
  ...
  # new in SC 1.15
  - record: sepp_tapcollector_out_tap_frames_truncated_total_rate
    expr: sum(rate(tapcollector_out_tap_frames_truncated_total{nf='sepp'}[90s]))
  - record: sepp_tapcollector_out_tap_frame_splits_total_rate
    expr: sum(rate(tapcollector_out_tap_frame_splits_total{nf='sepp'}[90s]))
