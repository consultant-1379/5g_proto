...
{{- define "eric-sc-slf.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sc-slf.mergeAnnotations" -}}
  {{- include "eric-sc-slf.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sc-slf.mergeLabels" -}}
  {{- include "eric-sc-slf.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
