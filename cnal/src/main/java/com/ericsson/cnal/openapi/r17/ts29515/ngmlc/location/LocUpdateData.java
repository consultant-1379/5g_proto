 ...
 */
@ApiModel(description = "Contains the input parameters in LocationUpdate service operation")
@JsonPropertyOrder({ LocUpdateData.JSON_PROPERTY_GPSI,
                     LocUpdateData.JSON_PROPERTY_SUPI,
                     LocUpdateData.JSON_PROPERTY_PSEUDONYM_INDICATOR,
                     LocUpdateData.JSON_PROPERTY_LOCATION_REQUEST_TYPE,
                     LocUpdateData.JSON_PROPERTY_LOCATION_ESTIMATE,
                     LocUpdateData.JSON_PROPERTY_AGE_OF_LOCATION_ESTIMATE,
                     LocUpdateData.JSON_PROPERTY_TIMESTAMP_OF_LOCATION_ESTIMATE,
                     LocUpdateData.JSON_PROPERTY_ACCURACY_FULFILMENT_INDICATOR,
                     LocUpdateData.JSON_PROPERTY_CIVIC_ADDRESS,
                     LocUpdateData.JSON_PROPERTY_LCS_QOS_CLASS,
                     LocUpdateData.JSON_PROPERTY_EXTERNAL_CLIENT_IDENTIFICATION,
                     LocUpdateData.JSON_PROPERTY_AF_ID,
                     LocUpdateData.JSON_PROPERTY_GMLC_NUMBER,
                     LocUpdateData.JSON_PROPERTY_LCS_SERVICE_TYPE })
public class LocUpdateData
{
    ...
    public static final String JSON_PROPERTY_PSEUDONYM_INDICATOR = "pseudonymIndicator";
    ...
    public static final String JSON_PROPERTY_GMLC_NUMBER = "gmlcNumber";
    ...
    public LocUpdateData()
    {
    }

    public LocUpdateData gpsi(String gpsi)
    {
    ...
    public LocUpdateData supi(String supi)
    {
    ...
    public LocUpdateData pseudonymIndicator(String pseudonymIndicator)
    {
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "It defines if a pseudonym is requested")
    @JsonProperty(JSON_PROPERTY_PSEUDONYM_INDICATOR)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public LocUpdateData locationRequestType(String locationRequestType)
    {
    ...
    public LocUpdateData locationEstimate(GeographicArea locationEstimate)
    {
    ...
    public LocUpdateData ageOfLocationEstimate(Integer ageOfLocationEstimate)
    {
    ...
    public LocUpdateData timestampOfLocationEstimate(OffsetDateTime timestampOfLocationEstimate)
    {
    ...
    public LocUpdateData accuracyFulfilmentIndicator(String accuracyFulfilmentIndicator)
    {
    ...
    public LocUpdateData civicAddress(CivicAddress civicAddress)
    {
    ...
    public LocUpdateData lcsQosClass(String lcsQosClass)
    {
    ...
    public LocUpdateData externalClientIdentification(String externalClientIdentification)
    {
    ...
    public LocUpdateData afId(String afId)
    {
    ...
    public LocUpdateData gmlcNumber(String gmlcNumber)
    {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(value = "")
    @JsonProperty(JSON_PROPERTY_GMLC_NUMBER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public LocUpdateData lcsServiceType(Integer lcsServiceType)
    {
    ...
    /**
     * LCS Service Type Id. minimum: 0 maximum: 127
     * 
     * @return lcsServiceType
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "LCS Service Type Id.")
    ...
    public boolean equals(Object o)
    {
        ...
        LocUpdateData locUpdateData = (LocUpdateData) o;
        return Objects.equals(this.gpsi, locUpdateData.gpsi) && Objects.equals(this.supi, locUpdateData.supi)
               && Objects.equals(this.pseudonymIndicator, locUpdateData.pseudonymIndicator)
               && Objects.equals(this.locationRequestType, locUpdateData.locationRequestType)
               && Objects.equals(this.locationEstimate, locUpdateData.locationEstimate)
               && Objects.equals(this.ageOfLocationEstimate, locUpdateData.ageOfLocationEstimate)
               && Objects.equals(this.timestampOfLocationEstimate, locUpdateData.timestampOfLocationEstimate)
               && Objects.equals(this.accuracyFulfilmentIndicator, locUpdateData.accuracyFulfilmentIndicator)
               && Objects.equals(this.civicAddress, locUpdateData.civicAddress) && Objects.equals(this.lcsQosClass, locUpdateData.lcsQosClass)
               && Objects.equals(this.externalClientIdentification, locUpdateData.externalClientIdentification) && Objects.equals(this.afId, locUpdateData.afId)
               && Objects.equals(this.gmlcNumber, locUpdateData.gmlcNumber) && Objects.equals(this.lcsServiceType, locUpdateData.lcsServiceType);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class LocUpdateData {\n");
        sb.append("    gpsi: ").append(toIndentedString(gpsi)).append("\n");
        sb.append("    supi: ").append(toIndentedString(supi)).append("\n");
        sb.append("    pseudonymIndicator: ").append(toIndentedString(pseudonymIndicator)).append("\n");
        ...
        sb.append("    gmlcNumber: ").append(toIndentedString(gmlcNumber)).append("\n");
