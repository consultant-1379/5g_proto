...
@JsonPropertyOrder({ ApnRateStatus.JSON_PROPERTY_REMAIN_PACKETS_UL,
                     ApnRateStatus.JSON_PROPERTY_REMAIN_PACKETS_DL,
                     ApnRateStatus.JSON_PROPERTY_VALIDITY_TIME,
                     ApnRateStatus.JSON_PROPERTY_REMAIN_EX_REPORTS_UL,
                     ApnRateStatus.JSON_PROPERTY_REMAIN_EX_REPORTS_DL })
public class ApnRateStatus
{
     ...
     * send uplink in the given time unit for the given APN (all PDN connections of
     * the UE to this APN see clause 4.7.7.3 in 3GPP TS 23.401. minimum: 0
     * 
     ...
     * (all PDN connections of the UE to this APN, see clause 4.7.7.3 in 3GPP TS
     * 23.401. minimum: 0
     * 
    ...
    /**
     * When present, it shall indicate the number of additional exception reports
     * the AF is allowed to send downlink in the given time unit for the given APN
     * (all PDN connections of the UE to this APN, see clause 4.7.7.3 in 3GPP TS
     * 23.401. minimum: 0
     * 
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.remainPacketsUl, apnRateStatus.remainPacketsUl) && Objects.equals(this.remainPacketsDl, apnRateStatus.remainPacketsDl)
               && Objects.equals(this.validityTime, apnRateStatus.validityTime) && Objects.equals(this.remainExReportsUl, apnRateStatus.remainExReportsUl)
