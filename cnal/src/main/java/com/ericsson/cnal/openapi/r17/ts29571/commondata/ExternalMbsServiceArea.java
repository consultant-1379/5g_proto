 ...
 */
@ApiModel(description = "List of geographic area or list of civic address info for MBS Service Area")
@JsonPropertyOrder({ ExternalMbsServiceArea.JSON_PROPERTY_GEOGRAPHIC_AREA_LIST, ExternalMbsServiceArea.JSON_PROPERTY_CIVIC_ADDRESS_LIST })
public class ExternalMbsServiceArea
{
    ...
    public ExternalMbsServiceArea()
    {
    }

    public ExternalMbsServiceArea geographicAreaList(List<GeographicArea> geographicAreaList)
    {
    ...
    public ExternalMbsServiceArea addGeographicAreaListItem(GeographicArea geographicAreaListItem)
    {
    ...
    public ExternalMbsServiceArea civicAddressList(List<CivicAddress> civicAddressList)
    {
    ...
    public ExternalMbsServiceArea addCivicAddressListItem(CivicAddress civicAddressListItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        ExternalMbsServiceArea externalMbsServiceArea = (ExternalMbsServiceArea) o;
        return Objects.equals(this.geographicAreaList, externalMbsServiceArea.geographicAreaList)
               && Objects.equals(this.civicAddressList, externalMbsServiceArea.civicAddressList);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class ExternalMbsServiceArea {\n");
