 ...
 */
@JsonPropertyOrder({ HssAuthenticationInfoResult.JSON_PROPERTY_SUPPORTED_FEATURES, HssAuthenticationInfoResult.JSON_PROPERTY_HSS_AUTHENTICATION_VECTORS })
public class HssAuthenticationInfoResult
{
    public static final String JSON_PROPERTY_SUPPORTED_FEATURES = "supportedFeatures";
    private String supportedFeatures;

    public static final String JSON_PROPERTY_HSS_AUTHENTICATION_VECTORS = "hssAuthenticationVectors";
    private Object hssAuthenticationVectors;

    public HssAuthenticationInfoResult()
    {
    }

    public HssAuthenticationInfoResult supportedFeatures(String supportedFeatures)
    {
    ...
    public HssAuthenticationInfoResult hssAuthenticationVectors(Object hssAuthenticationVectors)
    {
    ...
    /**
     * Get hssAuthenticationVectors
     * 
     * @return hssAuthenticationVectors
     **/
    @javax.annotation.Nonnull
    @ApiModelProperty(required = true, value = "")
    @JsonProperty(JSON_PROPERTY_HSS_AUTHENTICATION_VECTORS)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)

    public Object getHssAuthenticationVectors()
    {
        return hssAuthenticationVectors;
    }
    ...
    @JsonProperty(JSON_PROPERTY_HSS_AUTHENTICATION_VECTORS)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setHssAuthenticationVectors(Object hssAuthenticationVectors)
    {
        this.hssAuthenticationVectors = hssAuthenticationVectors;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        HssAuthenticationInfoResult hssAuthenticationInfoResult = (HssAuthenticationInfoResult) o;
        return Objects.equals(this.supportedFeatures, hssAuthenticationInfoResult.supportedFeatures)
               && Objects.equals(this.hssAuthenticationVectors, hssAuthenticationInfoResult.hssAuthenticationVectors);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(supportedFeatures, hssAuthenticationVectors);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class HssAuthenticationInfoResult {\n");
        sb.append("    supportedFeatures: ").append(toIndentedString(supportedFeatures)).append("\n");
        sb.append("    hssAuthenticationVectors: ").append(toIndentedString(hssAuthenticationVectors)).append("\n");
        sb.append("}");
        return sb.toString();
    }
