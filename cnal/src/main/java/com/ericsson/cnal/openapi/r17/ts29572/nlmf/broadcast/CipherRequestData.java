 ...
 */
@ApiModel(description = "Information within Ciphering Key Data request.")
@JsonPropertyOrder({ CipherRequestData.JSON_PROPERTY_AMF_CALL_BACK_U_R_I, CipherRequestData.JSON_PROPERTY_SUPPORTED_FEATURES })
public class CipherRequestData
{
    public static final String JSON_PROPERTY_AMF_CALL_BACK_U_R_I = "amfCallBackURI";
    private String amfCallBackURI;

    public static final String JSON_PROPERTY_SUPPORTED_FEATURES = "supportedFeatures";
    private String supportedFeatures;

    public CipherRequestData()
    {
    }

    public CipherRequestData amfCallBackURI(String amfCallBackURI)
    {
    ...
    @JsonProperty(JSON_PROPERTY_AMF_CALL_BACK_U_R_I)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setAmfCallBackURI(String amfCallBackURI)
    {
        this.amfCallBackURI = amfCallBackURI;
    }

    public CipherRequestData supportedFeatures(String supportedFeatures)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        CipherRequestData cipherRequestData = (CipherRequestData) o;
        return Objects.equals(this.amfCallBackURI, cipherRequestData.amfCallBackURI)
               && Objects.equals(this.supportedFeatures, cipherRequestData.supportedFeatures);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(amfCallBackURI, supportedFeatures);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class CipherRequestData {\n");
        sb.append("    amfCallBackURI: ").append(toIndentedString(amfCallBackURI)).append("\n");
