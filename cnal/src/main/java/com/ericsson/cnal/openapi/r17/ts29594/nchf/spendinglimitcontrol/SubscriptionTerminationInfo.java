 ...
 * the subscription.
 */
@ApiModel(description = "Represents the data structure presenting the indication of the termination of the  subscription. ")
@JsonPropertyOrder({ SubscriptionTerminationInfo.JSON_PROPERTY_SUPI,
                     SubscriptionTerminationInfo.JSON_PROPERTY_NOTIF_ID,
                     SubscriptionTerminationInfo.JSON_PROPERTY_TERM_CAUSE })
public class SubscriptionTerminationInfo
{
    ...
    public SubscriptionTerminationInfo()
    {
    }
    ...
    public SubscriptionTerminationInfo notifId(String notifId)
    {
    ...
    public SubscriptionTerminationInfo termCause(String termCause)
    {
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Represents the cause for requesting the termination of the subscription to policy counter status changes. ")
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.supi, subscriptionTerminationInfo.supi) && Objects.equals(this.notifId, subscriptionTerminationInfo.notifId)
    ...
    public int hashCode()
    {
        return Objects.hash(supi, notifId, termCause);
    }
