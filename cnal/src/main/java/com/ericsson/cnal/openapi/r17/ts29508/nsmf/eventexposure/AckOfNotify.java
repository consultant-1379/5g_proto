...
import com.ericsson.cnal.openapi.r17.ts29522.trafficinfluence.AfResultInfo;
 ...
 */
@ApiModel(description = "Represents an acknowledgement information of an event notification.")
@JsonPropertyOrder({ AckOfNotify.JSON_PROPERTY_NOTIF_ID, AckOfNotify.JSON_PROPERTY_ACK_RESULT, AckOfNotify.JSON_PROPERTY_SUPI, AckOfNotify.JSON_PROPERTY_GPSI })
public class AckOfNotify
{
    ...
    public AckOfNotify notifId(String notifId)
    {
    ...
    public AckOfNotify ackResult(AfResultInfo ackResult)
    {
    ...
    public AckOfNotify supi(String supi)
    {
    ...
    public AckOfNotify gpsi(String gpsi)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        AckOfNotify ackOfNotify = (AckOfNotify) o;
        return Objects.equals(this.notifId, ackOfNotify.notifId) && Objects.equals(this.ackResult, ackOfNotify.ackResult)
               && Objects.equals(this.supi, ackOfNotify.supi) && Objects.equals(this.gpsi, ackOfNotify.gpsi);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(notifId, ackResult, supi, gpsi);
    }
