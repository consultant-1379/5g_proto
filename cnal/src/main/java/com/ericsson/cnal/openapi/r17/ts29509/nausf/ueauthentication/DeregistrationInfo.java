 ...
 */
@ApiModel(description = "Contains the UE id (i.e. SUPI).")
@JsonPropertyOrder({ DeregistrationInfo.JSON_PROPERTY_SUPI, DeregistrationInfo.JSON_PROPERTY_SUPPORTED_FEATURES })
public class DeregistrationInfo
{
    ...
    public DeregistrationInfo supi(String supi)
    {
    ...
    public DeregistrationInfo supportedFeatures(String supportedFeatures)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        DeregistrationInfo deregistrationInfo = (DeregistrationInfo) o;
        return Objects.equals(this.supi, deregistrationInfo.supi) && Objects.equals(this.supportedFeatures, deregistrationInfo.supportedFeatures);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(supi, supportedFeatures);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class DeregistrationInfo {\n");
