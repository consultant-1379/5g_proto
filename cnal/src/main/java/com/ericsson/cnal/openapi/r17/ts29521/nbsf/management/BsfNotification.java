 ...
 */
@ApiModel(description = "Contains the event notifications.")
@JsonPropertyOrder({ BsfNotification.JSON_PROPERTY_NOTIF_CORRE_ID,
                     BsfNotification.JSON_PROPERTY_PCF_ID,
                     BsfNotification.JSON_PROPERTY_PCF_SET_ID,
                     BsfNotification.JSON_PROPERTY_BIND_LEVEL,
                     BsfNotification.JSON_PROPERTY_EVENT_NOTIFS })
public class BsfNotification
{
    ...
    public BsfNotification()
    {
    }

    public BsfNotification notifCorreId(String notifCorreId)
    {
    ...
    public BsfNotification pcfId(UUID pcfId)
    {
    ...
    public BsfNotification pcfSetId(String pcfSetId)
    {
    ...
    public BsfNotification bindLevel(String bindLevel)
    {
    ...
    public BsfNotification eventNotifs(List<BsfEventNotification> eventNotifs)
    {
    ...
    public BsfNotification addEventNotifsItem(BsfEventNotification eventNotifsItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        BsfNotification bsfNotification = (BsfNotification) o;
        return Objects.equals(this.notifCorreId, bsfNotification.notifCorreId) && Objects.equals(this.pcfId, bsfNotification.pcfId)
               && Objects.equals(this.pcfSetId, bsfNotification.pcfSetId) && Objects.equals(this.bindLevel, bsfNotification.bindLevel)
               && Objects.equals(this.eventNotifs, bsfNotification.eventNotifs);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(notifCorreId, pcfId, pcfSetId, bindLevel, eventNotifs);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class BsfNotification {\n");
