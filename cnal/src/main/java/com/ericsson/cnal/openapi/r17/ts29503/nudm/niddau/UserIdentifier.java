 ...
 */
@ApiModel(description = "Represents the user identifier.")
@JsonPropertyOrder({ UserIdentifier.JSON_PROPERTY_SUPI, UserIdentifier.JSON_PROPERTY_GPSI, UserIdentifier.JSON_PROPERTY_VALIDITY_TIME })
public class UserIdentifier
{
    ...
    public UserIdentifier supi(String supi)
    {
    ...
    public UserIdentifier gpsi(String gpsi)
    {
    ...
    public UserIdentifier validityTime(OffsetDateTime validityTime)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.supi, userIdentifier.supi) && Objects.equals(this.gpsi, userIdentifier.gpsi)
               && Objects.equals(this.validityTime, userIdentifier.validityTime);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(supi, gpsi, validityTime);
    }
