 ...
 */
@ApiModel(description = "This data type is defined in the same way as the 'Ambr' data type, but with the OpenAPI 'nullable: true' property.\" ")
@JsonPropertyOrder({ AmbrRm.JSON_PROPERTY_UPLINK, AmbrRm.JSON_PROPERTY_DOWNLINK })
public class AmbrRm
{
    ...
    public AmbrRm uplink(String uplink)
    {
    ...
    public AmbrRm downlink(String downlink)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        AmbrRm ambrRm = (AmbrRm) o;
        return Objects.equals(this.uplink, ambrRm.uplink) && Objects.equals(this.downlink, ambrRm.downlink);
    }
