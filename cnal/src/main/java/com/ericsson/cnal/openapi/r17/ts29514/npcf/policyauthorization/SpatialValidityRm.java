 ...
 */
@ApiModel(description = "This data type is defined in the same way as the SpatialValidity data type, but with the OpenAPI nullable property set to true.")
@JsonPropertyOrder({ SpatialValidityRm.JSON_PROPERTY_PRESENCE_INFO_LIST })
public class SpatialValidityRm
{
    ...
    public SpatialValidityRm()
    {
    }

    public SpatialValidityRm presenceInfoList(Map<String, PresenceInfo> presenceInfoList)
    {
    ...
    public SpatialValidityRm putPresenceInfoListItem(String key,
    ...
    public boolean equals(Object o)
    {
        ...
        SpatialValidityRm spatialValidityRm = (SpatialValidityRm) o;
        return Objects.equals(this.presenceInfoList, spatialValidityRm.presenceInfoList);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class SpatialValidityRm {\n");
