 ...
 */
@ApiModel(description = "This data type is defined in the same way as the 'BatteryIndication' data type, but with the OpenAPI 'nullable: true' property. ")
@JsonPropertyOrder({ BatteryIndicationRm.JSON_PROPERTY_BATTERY_IND,
                     BatteryIndicationRm.JSON_PROPERTY_REPLACEABLE_IND,
                     BatteryIndicationRm.JSON_PROPERTY_RECHARGEABLE_IND })
public class BatteryIndicationRm
{
    ...
    public BatteryIndicationRm()
    {
    }

    public BatteryIndicationRm batteryInd(Boolean batteryInd)
    {
    ...
    public BatteryIndicationRm replaceableInd(Boolean replaceableInd)
    {
    ...
    public BatteryIndicationRm rechargeableInd(Boolean rechargeableInd)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        BatteryIndicationRm batteryIndicationRm = (BatteryIndicationRm) o;
        return Objects.equals(this.batteryInd, batteryIndicationRm.batteryInd) && Objects.equals(this.replaceableInd, batteryIndicationRm.replaceableInd)
               && Objects.equals(this.rechargeableInd, batteryIndicationRm.rechargeableInd);
    }
