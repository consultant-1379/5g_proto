 ...
 */
@JsonPropertyOrder({ SliceAuthReauthNotification.JSON_PROPERTY_NOTIF_TYPE,
                     SliceAuthReauthNotification.JSON_PROPERTY_GPSI,
                     SliceAuthReauthNotification.JSON_PROPERTY_SNSSAI,
                     SliceAuthReauthNotification.JSON_PROPERTY_SUPI })
public class SliceAuthReauthNotification
{
    public static final String JSON_PROPERTY_NOTIF_TYPE = "notifType";
    private SliceAuthNotificationType notifType;
    ...
    public SliceAuthReauthNotification()
    {
    }

    public SliceAuthReauthNotification notifType(SliceAuthNotificationType notifType)
    {
    ...
    public SliceAuthNotificationType getNotifType()
    {
        return notifType;
    }
    ...
    @JsonProperty(JSON_PROPERTY_NOTIF_TYPE)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setNotifType(SliceAuthNotificationType notifType)
    {
        this.notifType = notifType;
    }

    public SliceAuthReauthNotification gpsi(String gpsi)
    {
    ...
    public SliceAuthReauthNotification snssai(Snssai snssai)
    {
    ...
    public SliceAuthReauthNotification supi(String supi)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        SliceAuthReauthNotification sliceAuthReauthNotification = (SliceAuthReauthNotification) o;
        return Objects.equals(this.notifType, sliceAuthReauthNotification.notifType) && Objects.equals(this.gpsi, sliceAuthReauthNotification.gpsi)
               && Objects.equals(this.snssai, sliceAuthReauthNotification.snssai) && Objects.equals(this.supi, sliceAuthReauthNotification.supi);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(notifType, gpsi, snssai, supi);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class SliceAuthReauthNotification {\n");
