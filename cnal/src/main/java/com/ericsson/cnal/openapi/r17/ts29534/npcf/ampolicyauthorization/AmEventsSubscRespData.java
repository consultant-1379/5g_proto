 ...
 * already met events.
 */
@ApiModel(description = "Identifies the events the application subscribes to within an AM Policy Events Subscription subresource data. It may contain the notification of the already met events.")
@JsonPropertyOrder({ AmEventsSubscRespData.JSON_PROPERTY_EVENT_NOTIF_URI,
                     AmEventsSubscRespData.JSON_PROPERTY_EVENTS,
                     AmEventsSubscRespData.JSON_PROPERTY_APP_AM_CONTEXT_ID,
                     AmEventsSubscRespData.JSON_PROPERTY_REP_EVENTS })
public class AmEventsSubscRespData
{
    ...
    public AmEventsSubscRespData()
    {
    }

    public AmEventsSubscRespData eventNotifUri(String eventNotifUri)
    {
    ...
    public AmEventsSubscRespData events(List<AmEventData> events)
    {
    ...
    public AmEventsSubscRespData addEventsItem(AmEventData eventsItem)
    {
        if (this.events == null)
        {
    ...
    public AmEventsSubscRespData appAmContextId(String appAmContextId)
    {
    ...
    public AmEventsSubscRespData repEvents(List<AmEventNotification> repEvents)
    {
    ...
    public AmEventsSubscRespData addRepEventsItem(AmEventNotification repEventsItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        AmEventsSubscRespData amEventsSubscRespData = (AmEventsSubscRespData) o;
        return Objects.equals(this.eventNotifUri, amEventsSubscRespData.eventNotifUri) && Objects.equals(this.events, amEventsSubscRespData.events)
               && Objects.equals(this.appAmContextId, amEventsSubscRespData.appAmContextId) && Objects.equals(this.repEvents, amEventsSubscRespData.repEvents);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(eventNotifUri, events, appAmContextId, repEvents);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class AmEventsSubscRespData {\n");
