 ...
 */
@ApiModel(description = "Contains NR V2X services authorized information.")
@JsonPropertyOrder({ NrV2xAuth.JSON_PROPERTY_VEHICLE_UE_AUTH, NrV2xAuth.JSON_PROPERTY_PEDESTRIAN_UE_AUTH })
public class NrV2xAuth
{
    ...
    public NrV2xAuth vehicleUeAuth(String vehicleUeAuth)
    {
    ...
    public NrV2xAuth pedestrianUeAuth(String pedestrianUeAuth)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        NrV2xAuth nrV2xAuth = (NrV2xAuth) o;
        return Objects.equals(this.vehicleUeAuth, nrV2xAuth.vehicleUeAuth) && Objects.equals(this.pedestrianUeAuth, nrV2xAuth.pedestrianUeAuth);
    }
