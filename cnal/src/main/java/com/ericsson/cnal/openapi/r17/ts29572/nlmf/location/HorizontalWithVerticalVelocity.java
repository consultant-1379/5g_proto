 ...
 */
@ApiModel(description = "Horizontal and vertical velocity.")
@JsonPropertyOrder({ HorizontalWithVerticalVelocity.JSON_PROPERTY_H_SPEED,
                     HorizontalWithVerticalVelocity.JSON_PROPERTY_BEARING,
                     HorizontalWithVerticalVelocity.JSON_PROPERTY_V_SPEED,
                     HorizontalWithVerticalVelocity.JSON_PROPERTY_V_DIRECTION })
public class HorizontalWithVerticalVelocity
{
    ...
    public HorizontalWithVerticalVelocity hSpeed(Float hSpeed)
    {
    ...
    public HorizontalWithVerticalVelocity bearing(Integer bearing)
    {
    ...
    public HorizontalWithVerticalVelocity vSpeed(Float vSpeed)
    {
    ...
    public HorizontalWithVerticalVelocity vDirection(VerticalDirection vDirection)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        HorizontalWithVerticalVelocity horizontalWithVerticalVelocity = (HorizontalWithVerticalVelocity) o;
        return Objects.equals(this.hSpeed, horizontalWithVerticalVelocity.hSpeed) && Objects.equals(this.bearing, horizontalWithVerticalVelocity.bearing)
               && Objects.equals(this.vSpeed, horizontalWithVerticalVelocity.vSpeed)
               && Objects.equals(this.vDirection, horizontalWithVerticalVelocity.vDirection);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(hSpeed, bearing, vSpeed, vDirection);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class HorizontalWithVerticalVelocity {\n");
