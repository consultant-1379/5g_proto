 ...
 */
@JsonPropertyOrder({ NrfInfoServedLmfInfoValue.JSON_PROPERTY_SERVING_CLIENT_TYPES,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_LMF_ID,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_SERVING_ACCESS_TYPES,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_SERVING_AN_NODE_TYPES,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_SERVING_RAT_TYPES,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_TAI_LIST,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_TAI_RANGE_LIST,
                     NrfInfoServedLmfInfoValue.JSON_PROPERTY_SUPPORTED_G_A_D_SHAPES })
@JsonTypeName("NrfInfo_servedLmfInfo_value")
public class NrfInfoServedLmfInfoValue
{
    ...
    public NrfInfoServedLmfInfoValue()
    {
    }

    public NrfInfoServedLmfInfoValue servingClientTypes(List<String> servingClientTypes)
    {
    ...
    public NrfInfoServedLmfInfoValue addServingClientTypesItem(String servingClientTypesItem)
    {
    ...
    public NrfInfoServedLmfInfoValue lmfId(String lmfId)
    {
    ...
    public NrfInfoServedLmfInfoValue servingAccessTypes(List<AccessType> servingAccessTypes)
    {
    ...
    public NrfInfoServedLmfInfoValue addServingAccessTypesItem(AccessType servingAccessTypesItem)
    {
    ...
    public NrfInfoServedLmfInfoValue servingAnNodeTypes(List<String> servingAnNodeTypes)
    {
    ...
    public NrfInfoServedLmfInfoValue addServingAnNodeTypesItem(String servingAnNodeTypesItem)
    {
    ...
    public NrfInfoServedLmfInfoValue servingRatTypes(List<String> servingRatTypes)
    {
    ...
    public NrfInfoServedLmfInfoValue addServingRatTypesItem(String servingRatTypesItem)
    {
    ...
    public NrfInfoServedLmfInfoValue taiList(List<Tai> taiList)
    {
    ...
    public NrfInfoServedLmfInfoValue addTaiListItem(Tai taiListItem)
    {
    ...
    public NrfInfoServedLmfInfoValue taiRangeList(List<TaiRange> taiRangeList)
    {
    ...
    public NrfInfoServedLmfInfoValue addTaiRangeListItem(TaiRange taiRangeListItem)
    {
    ...
    public NrfInfoServedLmfInfoValue supportedGADShapes(List<String> supportedGADShapes)
    {
    ...
    public NrfInfoServedLmfInfoValue addSupportedGADShapesItem(String supportedGADShapesItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        NrfInfoServedLmfInfoValue nrfInfoServedLmfInfoValue = (NrfInfoServedLmfInfoValue) o;
        return Objects.equals(this.servingClientTypes, nrfInfoServedLmfInfoValue.servingClientTypes)
               && Objects.equals(this.lmfId, nrfInfoServedLmfInfoValue.lmfId)
               && Objects.equals(this.servingAccessTypes, nrfInfoServedLmfInfoValue.servingAccessTypes)
               && Objects.equals(this.servingAnNodeTypes, nrfInfoServedLmfInfoValue.servingAnNodeTypes)
               && Objects.equals(this.servingRatTypes, nrfInfoServedLmfInfoValue.servingRatTypes)
               && Objects.equals(this.taiList, nrfInfoServedLmfInfoValue.taiList) && Objects.equals(this.taiRangeList, nrfInfoServedLmfInfoValue.taiRangeList)
               && Objects.equals(this.supportedGADShapes, nrfInfoServedLmfInfoValue.supportedGADShapes);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class NrfInfoServedLmfInfoValue {\n");
