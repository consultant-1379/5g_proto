 ...
 * AfExternal
 */
@JsonPropertyOrder({ AfExternal.JSON_PROPERTY_AF_ID,
                     AfExternal.JSON_PROPERTY_ALLOWED_GEOGRAPHIC_AREA,
                     AfExternal.JSON_PROPERTY_PRIVACY_CHECK_RELATED_ACTION,
                     AfExternal.JSON_PROPERTY_VALID_TIME_PERIOD })
public class AfExternal
{
    ...
    public AfExternal afId(String afId)
    {
    ...
    public AfExternal allowedGeographicArea(List<GeographicArea> allowedGeographicArea)
    {
    ...
    public AfExternal addAllowedGeographicAreaItem(GeographicArea allowedGeographicAreaItem)
    {
    ...
    public AfExternal privacyCheckRelatedAction(String privacyCheckRelatedAction)
    {
    ...
    public AfExternal validTimePeriod(ValidTimePeriod validTimePeriod)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        AfExternal afExternal = (AfExternal) o;
        return Objects.equals(this.afId, afExternal.afId) && Objects.equals(this.allowedGeographicArea, afExternal.allowedGeographicArea)
               && Objects.equals(this.privacyCheckRelatedAction, afExternal.privacyCheckRelatedAction)
               && Objects.equals(this.validTimePeriod, afExternal.validTimePeriod);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(afId, allowedGeographicArea, privacyCheckRelatedAction, validTimePeriod);
    }
