 ...
 */
@ApiModel(description = "Represents additional information and details on an error response.")
...
public class ProblemDetails
{
    ...
    @ApiModelProperty(value = "string providing an URI formatted according to IETF RFC 3986.")
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "A short, human-readable summary of the problem type. It should not change from occurrence to occurrence of the problem.")
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(value = "Description of invalid parameters, for a request rejected due to invalid parameters.")
