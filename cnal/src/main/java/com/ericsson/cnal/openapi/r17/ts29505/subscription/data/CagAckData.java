 ...
 */
@ApiModel(description = "Used to store the status of the latest CAG data update.")
@JsonPropertyOrder({ CagAckData.JSON_PROPERTY_PROVISIONING_TIME, CagAckData.JSON_PROPERTY_UE_UPDATE_STATUS })
public class CagAckData
{
    ...
    public CagAckData provisioningTime(OffsetDateTime provisioningTime)
    {
    ...
    public CagAckData ueUpdateStatus(UeUpdateStatus ueUpdateStatus)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        CagAckData cagAckData = (CagAckData) o;
        return Objects.equals(this.provisioningTime, cagAckData.provisioningTime) && Objects.equals(this.ueUpdateStatus, cagAckData.ueUpdateStatus);
    }
