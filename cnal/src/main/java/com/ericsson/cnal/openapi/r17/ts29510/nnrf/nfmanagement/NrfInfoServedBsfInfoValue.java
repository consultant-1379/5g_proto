 ...
 */
@JsonPropertyOrder({ NrfInfoServedBsfInfoValue.JSON_PROPERTY_DNN_LIST,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_IP_DOMAIN_LIST,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_IPV4_ADDRESS_RANGES,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_IPV6_PREFIX_RANGES,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_RX_DIAM_HOST,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_RX_DIAM_REALM,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_GROUP_ID,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_SUPI_RANGES,
                     NrfInfoServedBsfInfoValue.JSON_PROPERTY_GPSI_RANGES })
@JsonTypeName("NrfInfo_servedBsfInfo_value")
public class NrfInfoServedBsfInfoValue
{
    ...
    public NrfInfoServedBsfInfoValue()
    {
    }

    public NrfInfoServedBsfInfoValue dnnList(List<String> dnnList)
    {
    ...
    public NrfInfoServedBsfInfoValue addDnnListItem(String dnnListItem)
    {
    ...
    public NrfInfoServedBsfInfoValue ipDomainList(List<String> ipDomainList)
    {
    ...
    public NrfInfoServedBsfInfoValue addIpDomainListItem(String ipDomainListItem)
    {
    ...
    public NrfInfoServedBsfInfoValue ipv4AddressRanges(List<Ipv4AddressRange> ipv4AddressRanges)
    {
    ...
    public NrfInfoServedBsfInfoValue addIpv4AddressRangesItem(Ipv4AddressRange ipv4AddressRangesItem)
    {
    ...
    public NrfInfoServedBsfInfoValue ipv6PrefixRanges(List<Ipv6PrefixRange> ipv6PrefixRanges)
    {
    ...
    public NrfInfoServedBsfInfoValue addIpv6PrefixRangesItem(Ipv6PrefixRange ipv6PrefixRangesItem)
    {
    ...
    public NrfInfoServedBsfInfoValue rxDiamHost(String rxDiamHost)
    {
    ...
    public NrfInfoServedBsfInfoValue rxDiamRealm(String rxDiamRealm)
    {
    ...
    public NrfInfoServedBsfInfoValue groupId(String groupId)
    {
    ...
    public NrfInfoServedBsfInfoValue supiRanges(List<SupiRange> supiRanges)
    {
    ...
    public NrfInfoServedBsfInfoValue addSupiRangesItem(SupiRange supiRangesItem)
    {
    ...
    public NrfInfoServedBsfInfoValue gpsiRanges(List<IdentityRange> gpsiRanges)
    {
    ...
    public NrfInfoServedBsfInfoValue addGpsiRangesItem(IdentityRange gpsiRangesItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        NrfInfoServedBsfInfoValue nrfInfoServedBsfInfoValue = (NrfInfoServedBsfInfoValue) o;
        return Objects.equals(this.dnnList, nrfInfoServedBsfInfoValue.dnnList) && Objects.equals(this.ipDomainList, nrfInfoServedBsfInfoValue.ipDomainList)
               && Objects.equals(this.ipv4AddressRanges, nrfInfoServedBsfInfoValue.ipv4AddressRanges)
               && Objects.equals(this.ipv6PrefixRanges, nrfInfoServedBsfInfoValue.ipv6PrefixRanges)
               && Objects.equals(this.rxDiamHost, nrfInfoServedBsfInfoValue.rxDiamHost)
               && Objects.equals(this.rxDiamRealm, nrfInfoServedBsfInfoValue.rxDiamRealm) && Objects.equals(this.groupId, nrfInfoServedBsfInfoValue.groupId)
               && Objects.equals(this.supiRanges, nrfInfoServedBsfInfoValue.supiRanges)
               && Objects.equals(this.gpsiRanges, nrfInfoServedBsfInfoValue.gpsiRanges);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class NrfInfoServedBsfInfoValue {\n");
