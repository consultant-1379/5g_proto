 ...
 */
@ApiModel(description = "This data type is defined in the same way as the QosMonitoringInformation data type, but with the OpenAPI nullable property set to true.")
@JsonPropertyOrder({ QosMonitoringInformationRm.JSON_PROPERTY_REP_THRESH_DL,
                     QosMonitoringInformationRm.JSON_PROPERTY_REP_THRESH_UL,
                     QosMonitoringInformationRm.JSON_PROPERTY_REP_THRESH_RP })
