 ...
 */
@ApiModel(description = "The complete set of information relevant to an NWDAF serving the UE")
@JsonPropertyOrder({ NwdafRegistration.JSON_PROPERTY_NWDAF_INSTANCE_ID,
                     NwdafRegistration.JSON_PROPERTY_ANALYTICS_IDS,
                     NwdafRegistration.JSON_PROPERTY_NWDAF_SET_ID,
                     NwdafRegistration.JSON_PROPERTY_REGISTRATION_TIME,
                     NwdafRegistration.JSON_PROPERTY_CONTEXT_INFO,
                     NwdafRegistration.JSON_PROPERTY_SUPPORTED_FEATURES,
                     NwdafRegistration.JSON_PROPERTY_RESET_IDS })
public class NwdafRegistration
{
    ...
    private List<String> analyticsIds = new ArrayList<>();
    ...
    public NwdafRegistration()
    {
    }

    public NwdafRegistration nwdafInstanceId(UUID nwdafInstanceId)
    {
    ...
    public NwdafRegistration analyticsIds(List<String> analyticsIds)
    {
    ...
    public NwdafRegistration addAnalyticsIdsItem(String analyticsIdsItem)
    {
    ...
    public NwdafRegistration nwdafSetId(String nwdafSetId)
    {
    ...
    public NwdafRegistration registrationTime(OffsetDateTime registrationTime)
    {
    ...
    public NwdafRegistration contextInfo(ContextInfo contextInfo)
    {
    ...
    public NwdafRegistration supportedFeatures(String supportedFeatures)
    {
    ...
    public NwdafRegistration resetIds(List<String> resetIds)
    {
    ...
    public NwdafRegistration addResetIdsItem(String resetIdsItem)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        NwdafRegistration nwdafRegistration = (NwdafRegistration) o;
        return Objects.equals(this.nwdafInstanceId, nwdafRegistration.nwdafInstanceId) && Objects.equals(this.analyticsIds, nwdafRegistration.analyticsIds)
               && Objects.equals(this.nwdafSetId, nwdafRegistration.nwdafSetId) && Objects.equals(this.registrationTime, nwdafRegistration.registrationTime)
               && Objects.equals(this.contextInfo, nwdafRegistration.contextInfo) && Objects.equals(this.supportedFeatures, nwdafRegistration.supportedFeatures)
               && Objects.equals(this.resetIds, nwdafRegistration.resetIds);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(nwdafInstanceId, analyticsIds, nwdafSetId, registrationTime, contextInfo, supportedFeatures, resetIds);
    }
    ...
    public String toString()
    {
        ...
        sb.append("class NwdafRegistration {\n");
