...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    envoy_build_tools = dict(
        ...
        strip_prefix = "envoy-build-tools-f2a7f9ba09660beacfebcd37fc977480ec9a8f50",
        urls = ["https://github.com/envoyproxy/envoy-build-tools/archive/f2a7f9ba09660beacfebcd37fc977480ec9a8f50.tar.gz"],
    ...
    boringssl = dict(
        ...
        strip_prefix = "boringssl-1ce6682c7f6cfe0426ed54a37c10775bea9d3502",
        ...
        urls = ["https://github.com/google/boringssl/archive/1ce6682c7f6cfe0426ed54a37c10775bea9d3502.tar.gz"],
    ...
    com_github_google_libprotobuf_mutator = dict(
        ...
        strip_prefix = "libprotobuf-mutator-8942a9ba43d8bb196230c321d46d6a137957a719",
        urls = ["https://github.com/google/libprotobuf-mutator/archive/8942a9ba43d8bb196230c321d46d6a137957a719.tar.gz"],
    ...
    grpc_httpjson_transcoding = dict(
        ...
        strip_prefix = "grpc-httpjson-transcoding-22160afc7e67b9becce3198f8a6a321f01a3cef8",
        urls = ["https://github.com/grpc-ecosystem/grpc-httpjson-transcoding/archive/22160afc7e67b9becce3198f8a6a321f01a3cef8.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    com_github_wavm_wavm = dict(
        ...
        strip_prefix = "WAVM-e289ba654fe51655ab080819fd85ed9c936aae6e",
        urls = ["https://github.com/WAVM/WAVM/archive/e289ba654fe51655ab080819fd85ed9c936aae6e.tar.gz"],
    ...
    com_github_wasmtime = dict(
        ...
        urls = ["https://github.com/bytecodealliance/wasmtime/archive/v0.21.0.tar.gz"],
        release_date = "2020-11-05",
        use_category = ["dataplane_ext"],
    ...
    com_github_wasm_c_api = dict(
        ...
        urls = ["https://github.com/WebAssembly/wasm-c-api/archive/d9a80099d496b5cdba6f3fe8fc77586e0e505ddc.tar.gz"],
    ...
    com_github_curl = dict(
        ...
        urls = ["https://github.com/curl/curl/releases/download/curl-7_74_0/curl-7.74.0.tar.gz"],
...
#The envoyproxy-wee8 is a subconponent of envoy 1.16.0 so it is not essential to be checked seperately.
    #com_googlesource_chromium_v8 = dict(
        ...
        #url = ["https://storage.googleapis.com/envoyproxy-wee8/wee8-8.8.278.8.tar.gz"],
        #use_category = ["dataplane_ext"],
    ...
    com_googlesource_quiche = dict(
        ...
        urls = ["https://storage.googleapis.com/quiche-envoy-integration/ecc28c0d7428f3323ea26eb1ddb98a5e06b23dea.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    proxy_wasm_cpp_host = dict(
        ...
        strip_prefix = "proxy-wasm-cpp-host-6dab125d7a668c7158848b6f48c67fd827c952e6",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-host/archive/6dab125d7a668c7158848b6f48c67fd827c952e6.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.access_loggers.wasm",
            "envoy.bootstrap.wasm",
    ...
    proxy_wasm_rust_sdk = dict(
        ...
        strip_prefix = "proxy-wasm-rust-sdk-802cab2eabc1da106d8b8b7be2c7278b2bfadfbd",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-rust-sdk/archive/802cab2eabc1da106d8b8b7be2c7278b2bfadfbd.tar.gz"],
        use_category = ["test_only"],
    ...
    io_bazel_rules_rust = dict(
        ...
        urls = ["https://github.com/bazelbuild/rules_rust/archive/aa7c6938cf1cc2973bc065c7532f89874bf09818.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.wasm.runtime.wasmtime"],
        release_date = "2020-12-04",
        cpe = "N/A",
