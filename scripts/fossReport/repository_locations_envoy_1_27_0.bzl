...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_circonus_labs_libcircllhist = dict(
        ...
        cpe = "N/A",
        license = "Apache-2.0",
        license_url = "https://github.com/circonus-labs/libcircllhist/blob/39f9db724a81ba78f5d037f1cae79c5a07107c8e/LICENSE",
    ),
    ...
    com_google_protobuf = dict(
        ...
        urls = ["https://github.com/protocolbuffers/protobuf/releases/download/v23.1/protobuf-23.1.tar.gz"],
        use_category = ["dataplane_core","controlplane"],
    ...
    com_googlesource_code_re2 = dict(
        ...
        urls = ["https://github.com/google/re2/archive/2022-12-01.tar.gz"],
        use_category = ["controlplane","dataplane_core"],
