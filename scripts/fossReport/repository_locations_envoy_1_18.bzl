...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    rules_fuzzing = dict(
        ...
        urls = ["https://github.com/bazelbuild/rules_fuzzing/archive/v0.1.3.tar.gz"],
    ...
    envoy_build_tools = dict(
        ...
        strip_prefix = "envoy-build-tools-50ea97bb4289441f4f87537e8c145ffb79b1c9ba",
        urls = ["https://github.com/envoyproxy/envoy-build-tools/archive/50ea97bb4289441f4f87537e8c145ffb79b1c9ba.tar.gz"],
    ...
    com_github_c_ares_c_ares = dict(
        ...
        urls = ["https://github.com/c-ares/c-ares/releases/download/cares-1_17_1/c-ares-1.17.1.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
    ...
    com_github_google_libprotobuf_mutator = dict(
        ...
        urls = ["https://github.com/google/libprotobuf-mutator/archive/v1.0.tar.gz"],
    ...
    com_github_google_tcmalloc = dict(
        ...
        urls = ["https://github.com/google/tcmalloc/archive/9f385356c34d4fc11f76a000b609e2b446c20667.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
    ...
    com_github_nghttp2_nghttp2 = dict(
        ...
        urls = ["https://github.com/nghttp2/nghttp2/releases/download/v1.42.0/nghttp2-1.42.0.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
    ...
    com_lightstep_tracer_cpp = dict(
        ...
        strip_prefix = "lightstep-tracer-cpp-1942b3f142e218ebc143a043f32e3278dafec9aa",
        urls = ["https://github.com/lightstep/lightstep-tracer-cpp/archive/1942b3f142e218ebc143a043f32e3278dafec9aa.tar.gz"],
        use_category = ["observability_ext"],
    ...
    com_github_skyapm_cpp2sky = dict(
        ...
        version = "0.1.1",
        strip_prefix = "cpp2sky-0.1.1",
        urls = ["https://github.com/SkyAPM/cpp2sky/archive/v0.1.1.tar.gz"],
        use_category = ["observability_ext"],
        extensions = ["envoy.tracers.skywalking"],
    ...
    com_github_datadog_dd_opentracing_cpp = dict(
        ...
        strip_prefix = "dd-opentracing-cpp-1.2.1",
        urls = ["https://github.com/DataDog/dd-opentracing-cpp/archive/v1.2.1.tar.gz"],
        use_category = ["observability_ext"],
    ...
    org_brotli = dict(
        ...
        strip_prefix = "brotli-0cd2e3926e95e7e2930f57ae3f4885508d462a25",
        urls = ["https://github.com/google/brotli/archive/0cd2e3926e95e7e2930f57ae3f4885508d462a25.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
    ...
    com_github_zlib_ng_zlib_ng = dict(
        ...
        strip_prefix = "zlib-ng-b802a303ce8b6c86fbe3f93d59e0a82333768c0c",
        urls = ["https://github.com/zlib-ng/zlib-ng/archive/b802a303ce8b6c86fbe3f93d59e0a82333768c0c.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
    ...
    com_github_google_jwt_verify = dict(
        ...
        urls = ["https://github.com/google/jwt_verify_lib/archive/28efec2e4df1072db0ed03597591360ec9f80aac.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    grpc_httpjson_transcoding = dict(
        ...
        strip_prefix = "grpc-httpjson-transcoding-909368951e9a447098f87e41bc49e37810af99f5",
        urls = ["https://github.com/grpc-ecosystem/grpc-httpjson-transcoding/archive/909368951e9a447098f87e41bc49e37810af99f5.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    com_github_wavm_wavm = dict(
        ...
        urls = ["https://github.com/WAVM/WAVM/archive/79c3aa29366615d9b1593cd527e5b4b94cc6072a.tar.gz"],
    ...
    com_github_wasmtime = dict(
        ...
        urls = ["https://github.com/bytecodealliance/wasmtime/archive/v0.26.0.tar.gz"],
        release_date = "2021-04-05",
        use_category = ["dataplane_ext"],
    ...
    com_github_wasm_c_api = dict(
        ...
        urls = ["https://github.com/WebAssembly/wasm-c-api/archive/c9d31284651b975f05ac27cee0bab1377560b87e.tar.gz"],
    ...
    io_opencensus_cpp = dict(
        ...
        strip_prefix = "opencensus-cpp-ba631066779a534267fdb1321b19850eb2b0c000",
        urls = ["https://github.com/census-instrumentation/opencensus-cpp/archive/ba631066779a534267fdb1321b19850eb2b0c000.tar.gz"],
        use_category = ["observability_ext"],
    ...
    com_github_curl = dict(
        ...
        urls = ["https://github.com/curl/curl/releases/download/curl-7_76_0/curl-7.76.0.tar.gz"],
    ...
    #com_googlesource_chromium_v8 = dict(
        ...
        #url = ["https://storage.googleapis.com/envoyproxy-wee8/wee8-9.0.257.17.tar.gz"],
        #use_category = ["dataplane_ext"],
    ...
    com_googlesource_quiche = dict(
        ...
        urls = ["https://storage.googleapis.com/quiche-envoy-integration/88c8d5903d851744410ea9840201b6507feae981.tar.gz"],
    ...
    com_google_cel_cpp = dict(
        ...
        strip_prefix = "cel-cpp-9841e3ee251f3cc4cd5b6dd9deee6818bc9f2854",
        urls = ["https://github.com/google/cel-cpp/archive/9841e3ee251f3cc4cd5b6dd9deee6818bc9f2854.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
    ...
    org_llvm_releases_compiler_rt = dict(
        ...
        strip_prefix = "compiler-rt-11.0.1.src",
        urls = ["https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.1/compiler-rt-11.0.1.src.tar.xz"],
    ...
    upb = dict(
        ...
        urls = ["https://github.com/protocolbuffers/upb/archive/de76b31f9c56b28120580d53a6f8d7941fdb79eb.tar.gz"],
    ...
    kafka_source = dict(
        ...
        strip_prefix = "kafka-2.4.1/clients/src/main/resources/common/message",
        urls = ["https://github.com/apache/kafka/archive/2.4.1.zip"],
        use_category = ["dataplane_ext"],
    ...
    kafka_server_binary = dict(
        ...
        urls = ["https://archive.apache.org/dist/kafka/2.4.1/kafka_2.12-2.4.1.tgz"],
    ...
    kafka_python_client = dict(
        ...
        strip_prefix = "kafka-python-2.0.1",
        urls = ["https://github.com/dpkp/kafka-python/archive/2.0.1.tar.gz"],
    ...
    proxy_wasm_cpp_sdk = dict(
        ...
        strip_prefix = "proxy-wasm-cpp-sdk-258b4c6974dba5255a9c433450971a56b29228ff",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-sdk/archive/258b4c6974dba5255a9c433450971a56b29228ff.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.access_loggers.wasm",
            "envoy.bootstrap.wasm",
    ...
    proxy_wasm_cpp_host = dict(
        ...
        strip_prefix = "proxy-wasm-cpp-host-aba2704bcd7d8adce2ccaf07c4ecbaf0cffeb7ef",
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-host/archive/aba2704bcd7d8adce2ccaf07c4ecbaf0cffeb7ef.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = [
            "envoy.access_loggers.wasm",
            "envoy.bootstrap.wasm",
    ...
    emscripten_toolchain = dict(
        ...
        urls = ["https://github.com/emscripten-core/emsdk/archive/2.0.7.tar.gz"],
        use_category = ["build"],
    ...
    rules_rust = dict(
        ...
        urls = ["https://github.com/bazelbuild/rules_rust/archive/1b648302edb64d3ddcc159655bf065bff40e6571.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.wasm.runtime.wasmtime"],
