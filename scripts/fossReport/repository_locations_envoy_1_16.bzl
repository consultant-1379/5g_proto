...
DEPENDENCY_REPOSITORIES_SPEC = dict(
    ...
    envoy_build_tools = dict(
        ...
        strip_prefix = "envoy-build-tools-0ba5aa98a6e6c5efcc63f53602f69548d2417683",
        urls = ["https://github.com/envoyproxy/envoy-build-tools/archive/0ba5aa98a6e6c5efcc63f53602f69548d2417683.tar.gz"],
    ...
    boringssl = dict(
        ...
        urls = ["https://github.com/google/boringssl/archive/597b810379e126ae05d32c1d94b1a9464385acd0.tar.gz"],
    ...
    com_google_absl = dict(
        ...
        urls = ["https://github.com/abseil/abseil-cpp/archive/093cc27604df1c4a179b73bc3f00d4d1ce2ce113.tar.gz"],
    ...
    com_github_google_tcmalloc = dict(
        ...
        urls = ["https://github.com/google/tcmalloc/archive/d1311bf409db47c3441d3de6ea07d768c6551dec.tar.gz"],
        use_category = ["dataplane_core", "controlplane"],
    ...
    rules_foreign_cc = dict(
        ...
        strip_prefix = "rules_foreign_cc-594bf4d7731e606a705f3ad787dd0a70c5a28b30",
        urls = ["https://github.com/bazelbuild/rules_foreign_cc/archive/594bf4d7731e606a705f3ad787dd0a70c5a28b30.tar.gz"],
    ...
    com_github_curl = dict(
        ...
        urls = ["https://github.com/curl/curl/releases/download/curl-7_72_0/curl-7.72.0.tar.gz"],
...
#The envoyproxy-wee8 is a subconponent of envoy 1.16.0 so it is not essential to be checked seperately.
    # com_googlesource_chromium_v8 = dict(
      ...
      #  url = ["https://storage.googleapis.com/envoyproxy-wee8/wee8-8.5.210.20.tar.gz"],
      #  use_category = ["dataplane_ext"],
      #  extensions = [
   ...
   # ),
    com_googlesource_quiche = dict(
        ...
        urls = ["https://storage.googleapis.com/quiche-envoy-integration/f555d99a084cdd086a349548c70fb558ac5847cf.tar.gz"],
        use_category = ["dataplane_ext"],
