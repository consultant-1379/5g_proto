...
export CFHSIM_NODEPORT=$(<KUBECTL_EXECUTABLE_TOOLS> get svc eric-chfsim-11 -n <TOOLS_NAMESPACE> -o jsonpath='{.spec.ports[0].nodePort}')
export NRFSIM_NODEPORT=$(<KUBECTL_EXECUTABLE_TOOLS> get svc eric-nrfsim -n <TOOLS_NAMESPACE> -o jsonpath='{.spec.ports[0].nodePort}')

curl -X POST "http://$NODE_IP_TRAFFIC:$CFHSIM_NODEPORT/admin/v1/nrf/set_nf_profile" -H "Content-Type: application/json" -d '{"nfInstanceId":null,"nfType":"CUSTOM_CHF","nfStatus":"REGISTERED","plmnList":[{"mcc":"412","mnc":"088"}],"sNssais":[{"sst":11011,"sd":"Aa11011"}], "locality":"Canada","nfServices":[{"serviceInstanceId":"Pool2.LABCHF.VCCOSL5GL10","serviceName":"nchf-convergedcharging","versions":[{"apiVersionInUri":"v2","apiFullVersion":"2.0.0"},{"apiVersionInUri":"v3","apiFullVersion":"3.0.1"}], "scheme":"http","nfServiceStatus":"REGISTERED","fqdn":"eric-chfsim-11","ipEndPoints":[{"ipv4Address":"'$NODE_IP_TRAFFIC'","transport":"TCP","port":'$CFHSIM_NODEPORT'}],"priority":1,"capacity":20,"nfServiceSetIdList":["setB"],"oauth2Required":false}, {"serviceInstanceId":"Pool2.LABCHF.VCCOSL5GL00","serviceName":"nchf-spendinglimitcontrol","versions":[{"apiVersionInUri":"v1","apiFullVersion":"1.1.3"}], "scheme":"http","nfServiceStatus":"REGISTERED","fqdn":"eric-chfsim-11","ipEndPoints":[{"ipv4Address":"'$NODE_IP_TRAFFIC'","transport":"TCP","port":'$CFHSIM_NODEPORT'}],"priority":1,"capacity":20,"nfServiceSetIdList":["setB"],"oauth2Required":false}], "nfServiceList":{"nchf-spendinglimitcontrolhttp":{"serviceInstanceId":"Pool2.LABCHF.VCCOSL5GL00","serviceName":"nchf-spendinglimitcontrol","versions":[{"apiVersionInUri":"v1","apiFullVersion":"1.1.3"}], "scheme":"http","nfServiceStatus":"REGISTERED","fqdn":"eric-chfsim-11","ipEndPoints":[{"ipv4Address":"'$NODE_IP_TRAFFIC'","transport":"TCP","port":'$CFHSIM_NODEPORT'}],"priority":1,"capacity":20, "nfServiceSetIdList":["setB"],"oauth2Required":false},"nchf-convergedcharginghttp":{"serviceInstanceId":"Pool2.LABCHF.VCCOSL5GL10","serviceName":"nchf-convergedcharging", "versions":[{"apiVersionInUri":"v2","apiFullVersion":"2.0.0"},{"apiVersionInUri":"v3","apiFullVersion":"3.0.1"}], "scheme":"http","nfServiceStatus":"REGISTERED","fqdn":"eric-chfsim-11","ipEndPoints":[{"ipv4Address":"'$NODE_IP_TRAFFIC'","transport":"TCP","port":'$CFHSIM_NODEPORT'}],"priority":1,"capacity":20, "nfServiceSetIdList":["setB"],"oauth2Required":false}},"nfSetIdList":["setB"],"scpDomains":["ericsson.se"]}'
