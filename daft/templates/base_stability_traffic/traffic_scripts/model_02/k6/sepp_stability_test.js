...
const headers_sr = {
    headers: {
        ...
        "3gpp-Sbi-target-apiRoot": `${__ENV.SCHEME}://${__ENV.TARGET_HOST_1}.${__ENV.TARGET_DOMAIN_1}:${__ENV.TARGET_NF_PORT_1}`
    }
};
...
const headers_pr = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-target-apiRoot": `${__ENV.SCHEME}://${__ENV.TARGET_HOST_2}.${__ENV.TARGET_DOMAIN_2}:${__ENV.TARGET_NF_PORT_2}`
    }
};
...
const headers_inter_udm_sdm_init_nf_filter = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-Target-apiRoot": `http://sepp8.5gc.mnc567.mcc765.${__ENV.NAMESPACE}.3gppnetwork.org`
    }
};
...
export default function () {
    ...
    if ((`${__ENV.TARGET_DOMAIN_1}` === `5gc.mnc567.mcc765.${__ENV.NAMESPACE}.3gppnetwork.org`) && (`${__ENV.NF_FILTER_ENABLED}` === "true")) {
...
function nudm_sdm_subscribe_nf_filter(scheme, sepp, traffic) {
    ...
    if (traffic > 0) {
        ...
        headers_inter_udm_sdm_init_nf_filter.headers["3gpp-Sbi-Target-apiRoot"] = "http://sepp" + p_index + `.5gc.mnc567.mcc765.${__ENV.NAMESPACE}.3gppnetwork.org`;
