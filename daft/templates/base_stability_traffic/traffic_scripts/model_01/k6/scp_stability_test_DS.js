...
const headers_sr1 = {
        headers: {
            ...
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled === "true") ? "https://eric-seppsim-p7-mcc-262-mnc-73.eiffelesc-tools:30361": "http://eric-seppsim-p7-mcc-262-mnc-73.eiffelesc-tools:30580"
        }
    };
...
const headers_sr2 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled=== "true") ? "https://eric-seppsim-p8-mcc-262-mnc-73.eiffelesc-tools:32403": "http://eric-seppsim-p8-mcc-262-mnc-73.eiffelesc-tools:31735"
        }
    };
...
const headers_sr3 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled=== "true") ? "https://eric-seppsim-p3-mcc-262-mnc-73.eiffelesc-tools:30614": "http://eric-seppsim-p3-mcc-262-mnc-73.eiffelesc-tools:30409"
        }
    };
...
const headers_sr4 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled=== "true") ? "https://eric-seppsim-p4-mcc-262-mnc-73.eiffelesctools:30986": "http://eric-seppsim-p4-mcc-262-mnc-73.eiffelesc-tools:31263"
        }
    };
...
const headers_pr1 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled=== "true") ? "https://eric-seppsim-p5-mcc-262-mnc-73.eiffelesc-tools": "http://eric-seppsim-p5-mcc-262-mnc-73.eiffelesc-tools:31397"
        }
    };
...
const headers_pr2 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "3gpp-Sbi-target-apiRoot":(egressTlsEnabled=== "true") ? "https://eric-seppsim-p6-mcc-262-mnc-73.eiffelesc-tools": "http://eric-seppsim-p6-mcc-262-mnc-73.eiffelesc-tools:30876"
        }
    };
...
export default function() {
    ...
    send_sr_n8_traffic_pref_ip_fam(scp, headers_sr3, headers_sr4, `${__ENV.SR}`/2);
...
//Function to send traffic for strict routing ipv4 & ipv6 prodcucers
...
//Function to send traffic for strict routing ipv4 & ipv6 prodcucers with preferred rotuing set
function send_sr_n8_traffic_pref_ip_fam(scp, headers3, headers4, traffic) {
    ...
    if(traffic>0){
        ...
        if( (i % 2) == 0 ){
            requests[i] = [method, scp + uri_n8, body, headers3];
        }

        if( (i % 2) == 1 ){
            requests[i] = [method, scp + uri_n8, body, headers4];
        }
        ...
        {
            check(responses[i], {
                "SR/N8 pref. IP Family traffic: protocol is HTTP/2": (r) => r.proto === 'HTTP/2.0',
                "SR/N8 pref. IP Family traffic: status was 200": (r) => r.status == 200
            });
        }
