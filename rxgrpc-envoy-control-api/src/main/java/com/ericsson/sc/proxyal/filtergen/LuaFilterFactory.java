...
class LuaFilterFactory
{
    ...
    static class Request
    {
        static class Path
        {
             ...
             * @return
             */
            public static Object contains(String string)
            {
    ...
    private static final Logger log = LoggerFactory.getLogger(LuaFilterFactory.class);

    private static final String LUA_TEMPLATE_FILE = "lua_filter_modular.vm";
     ...
     * @return
     */
    public static String getCsaLuaFilter(final List<RequestHandler> reqHandlers)
    {
        ...
        context.put("handlers", reqHandlers);
