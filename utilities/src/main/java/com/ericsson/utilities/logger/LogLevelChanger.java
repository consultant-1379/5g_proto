 ...
 * Log level changer
 * <p>
 * Used for changing the logback logger level
 */
public class LogLevelChanger implements AutoCloseable
{
    private static final Logger log = LoggerFactory.getLogger(LogLevelChanger.class);
     ...
     * @param containerName the contaner name that exists in log control configmap
     */
    public LogLevelChanger(ConfigmapWatch configmap,
                           String loggerName,
