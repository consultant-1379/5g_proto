...
{{- define "eric-sc-rlf.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sc-rlf.mergeAnnotations" -}}
  {{- include "eric-sc-rlf.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sc-rlf.mergeLabels" -}}
  {{- include "eric-sc-rlf.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
