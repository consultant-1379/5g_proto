...
function process_response_headers(responses) {
   ...
   for (let i=0;i<resp_length;i++) {
	  ...
	  || location.includes("p4") || location.includes("p5") || location.includes("p6") || location.includes("p7") || location.includes("p8"))) {
...
//          "x-notify-uri": "http://eric-chfsim-1/nchf-spendinglimitcontrol/v1/subscriptions/notify"
            "x-notify-uri": "http://eric-chfsim-1-mnc-123-mcc-123/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"    
        }
    }
    ...
    const headers_chfsim_2 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-2-mnc-123-mcc-123/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"    
        }
    }
    ...
    const headers_chfsim_3 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-3-mnc-456-mcc-456/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"    
        }
	}
