...
const headers_sr1 = {
    headers: {
        ...
        "3gpp-Sbi-target-apiRoot": (egressTlsEnabled === "true") ? "https://eric-seppsim-p7-mcc-262-mnc-73" : "http://eric-seppsim-p7-mcc-262-mnc-73"
    }
};
...
const headers_sr2 = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-target-apiRoot": (egressTlsEnabled === "true") ? "https://eric-seppsim-p8-mcc-262-mnc-73" + apiPrefix : "http://eric-seppsim-p8-mcc-262-mnc-73" + apiPrefix
    }
};
...
const headers_sr3_interPlmn = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-target-apiRoot": (egressTlsEnabled === "true") ? `https://nfudm1.${__ENV.NAMESPACE}.scp.mnc073.mcc262.3gppnetwork.org` : `http://nfudm1.${__ENV.NAMESPACE}.scp.mnc073.mcc262.3gppnetwork.org`
    }
};
...
const headers_pr3_interPlmn = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-target-apiRoot": (egressTlsEnabled === "true") ? `https://nfudm2.${__ENV.NAMESPACE}.scp.mnc073.mcc262.3gppnetwork.org` : `http://nfudm2.${__ENV.NAMESPACE}.scp.mnc073.mcc262.3gppnetwork.org`
    }
};
...
const headers_inter_udm_sdm_init_nf_filter = {
    headers: {
        ...
        "Content-Type": "application/json",
        "Accept": "application/json",
        "3gpp-Sbi-Target-apiRoot": "http://eric-seppsim-p3-mcc-262-mnc-73"
    }
};
...
function nudm_sdm_subscribe_nf_filter(smf_host, scp, traffic) {
    ...
    if (traffic > 0) {
        ...
        body = body.replace("msisdn-77117772", "msisdn-77117776"); // to differantiate rr condition
