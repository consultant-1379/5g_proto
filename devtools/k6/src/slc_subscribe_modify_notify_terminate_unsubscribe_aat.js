...
if(slc_notify>0){
    ...
    const headers_chfsim_1 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-1-mnc-123-mcc-123/nchf-spendinglimitcontrol/v1/subscriptions/notify"
//          "x-notify-uri": "http://eric-chfsim-1/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"    
    ...
    const headers_chfsim_2 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-2-mnc-123-mcc-123/nchf-spendinglimitcontrol/v1/subscriptions/notify"
        }
    }
    ...
    const headers_chfsim_3 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-3-mnc-456-mcc-456/nchf-spendinglimitcontrol/v1/subscriptions/notify"
        }
    }
...
if(slc_terminate>0){
    ...
    const headers_chfsim_1 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-1-mnc-123-mcc-123/nchf-spendinglimitcontrol/v1/subscriptions/terminate"
//          "x-notify-uri": "http://eric-chfsim-1/nchf-convergedcharging/v1/subscriptions/notify_cc_receiver"    
    ...
    const headers_chfsim_2 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-2-mnc-123-mcc-123/nchf-spendinglimitcontrol/v1/subscriptions/terminate"
        }
    }
    ...
    const headers_chfsim_3 = {
        headers: {
            ...
            "Content-Type": "application/json",
            "Accept": "application/json",
            "x-notify-uri": "http://eric-chfsim-3-mnc-456-mcc-456/nchf-spendinglimitcontrol/v1/subscriptions/terminate"
        }
    }
