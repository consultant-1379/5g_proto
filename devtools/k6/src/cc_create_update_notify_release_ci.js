	...
	if (notify > 0) {
		...
		const headers_chfsim_1 = {
			headers: {
				...
				"Content-Type": "application/json",
				"Accept": "application/json",
				"3gpp-Sbi-target-apiRoot": "http://eric-chfsim-1/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"
			}
		}
		...
		const headers_chfsim_3 = {
			headers: {
				...
				"Content-Type": "application/json",
				"Accept": "application/json",
				"3gpp-Sbi-target-apiRoot": "http://eric-chfsim-3/nchf-convergedcharging/v1/chargingdata/notify_cc_receiver"
			}
		}
