...
let slc_subscribe = parseInt(`${__ENV.SLC_SUBSCRIBE}`);
let slc_modify = parseInt(`${__ENV.SLC_MODIFY}`);
let slc_unsubscribe = parseInt(`${__ENV.SLC_UNSUBSCRIBE}`); 
let slc_notify = parseInt(`${__ENV.SLC_NOTIFY}`);
let slc_terminate = parseInt(`${__ENV.SLC_TERMINATE}`); 
let total = slc_subscribe + slc_modify + slc_unsubscribe + slc_notify + slc_terminate;
