...
public final class InfluxDb extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "influxdb";

    private static final String KEY_NAME = "sc-influxdb-default-key";
    private static final String CERT_NAME = "sc-influxdb-default-cert";

    private static final String FQDN = "eric-influxdb";

    /**
     * @param config
     */
    public InfluxDb(Configuration config)
    {
        super(config);
    }
