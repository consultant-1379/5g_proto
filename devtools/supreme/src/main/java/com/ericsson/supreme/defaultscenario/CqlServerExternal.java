...
public final class CqlServerExternal extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "cql-server-external";

    private static final String KEY_NAME = "cql-server-external-key";
    private static final String CERT_NAME = "cql-server-external-cert";
     ...
     * @param config
     */
    public CqlServerExternal(Configuration config)
    {
        super(config);
    }
