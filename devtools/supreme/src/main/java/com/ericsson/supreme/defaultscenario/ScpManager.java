...
public final class ScpManager extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "scpmgr";
     ...
     * @param config
     */
    public ScpManager(Configuration config)
    {
        super(config);
    }
