...
public final class ReferralLdap extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "referral-ldap";

    private static final String KEY_NAME = "sc-referral-ldap-default-key";
    private static final String CERT_NAME = "sc-referral-ldap-default-cert";

    private static final String FQDN = "eric-referral-ldap";

    /**
     * @param config
     */
    public ReferralLdap(Configuration config)
    {
        super(config);
    }
