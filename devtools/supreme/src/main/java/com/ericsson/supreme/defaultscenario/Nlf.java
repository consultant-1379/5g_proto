...
public final class Nlf extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "nlf";

    private static final String KEY_NAME = "sc-nrf-default-key";
    private static final String CERT_NAME = "sc-nrf-default-cert";

    private static final String FQDN = "eric-sc-nlf";

    /**
     * @param config
     */
    public Nlf(Configuration config)
    {
        super(config);
    }
