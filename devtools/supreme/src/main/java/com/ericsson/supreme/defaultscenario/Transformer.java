...
public final class Transformer extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "transformer";

    private static final String KEY_NAME = "syslog-default-key-cert";
    private static final String CERT_NAME = "syslog-default-key-cert";

    private static final String FQDN = "eric-log-transformer";
