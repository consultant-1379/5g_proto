...
public final class CqlClientExternal extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "cql-client-external";

    private static final String KEY_NAME = "cql-client-external-key";
    private static final String CERT_NAME = "cql-client-external-cert";
     ...
     * @param config
     */
    public CqlClientExternal(Configuration config)
    {
        super(config);
    }
