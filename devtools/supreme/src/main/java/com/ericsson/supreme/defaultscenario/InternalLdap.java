...
public final class InternalLdap extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    ...
    private static final String KEY_NAME = "sc-ldap-default-cert";
    private static final String CERT_NAME = "sc-ldap-default-cert";

    private static final String FQDN = "eric-sec-ldap-server";

    /**
     * @param config
     */
    public InternalLdap(Configuration config)
    {
        super(config);
    }
