...
public final class BsfWorker extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "bsfwrk";
     ...
     * @param config
     */
    public BsfWorker(Configuration config)
    {
        super(config);
    }
