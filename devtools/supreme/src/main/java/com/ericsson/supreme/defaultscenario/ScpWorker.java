...
public final class ScpWorker extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "scpwrk";

    private static final String KEY_NAME = "sc-traf-default-key";
    private static final String CERT_NAME = "sc-traf-default-cert";

    private static final String FQDN = "scp.ericsson.se";

    /**
     * @param config
     */
    public ScpWorker(Configuration config)
    {
        super(config);
    }
