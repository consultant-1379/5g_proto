...
public final class Syslog extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    ...
    private static final String KEY_NAME = "sc-syslog-default-key";
    private static final String CERT_NAME = "sc-syslog-default-cert";

    private static final String FQDN = "eric-syslog";

    /**
     * @param config
     */
    public Syslog(Configuration config)
    {
        super(config);
    }
