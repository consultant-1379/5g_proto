...
public final class BsfManager extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "bsfmgr";

    private static final String KEY_NAME = "sc-nrf-default-key";
    private static final String CERT_NAME = "sc-nrf-default-cert";
    private static final String FQDN = "bsf.ericsson.se";

    /**
     * @param config
     */
    public BsfManager(Configuration config)
    {
        super(config);
    }
