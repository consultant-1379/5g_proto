...
public final class TransformerExternal extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "ext-lj";

    private static final String KEY_NAME = "ext-lj-key-cert";
    private static final String CERT_NAME = "ext-lj-key-cert";

    private static final String FQDN = "eric-ext-log-transformer";

    /**
     * @param config
     */
    public TransformerExternal(Configuration config)
    {
        super(config);
    }
