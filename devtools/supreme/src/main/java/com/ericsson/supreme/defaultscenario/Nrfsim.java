...
public final class Nrfsim extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;
    private GeneratedCert ca;

    private static final String NAME = "nrfsim";

    private static final String SECRET_NAME = "nrf-certificates";

    private static final String FQDN = "eric-nrfsim";

    /**
     * @param config
     */
    public Nrfsim(Configuration config)
    {
        super(config);
    }
