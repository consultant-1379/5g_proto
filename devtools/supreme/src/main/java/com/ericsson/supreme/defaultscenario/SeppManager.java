...
public final class SeppManager extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "seppmgr";

    private static final String KEY_NAME = "sc-nrf-default-key";
    private static final String CERT_NAME = "sc-nrf-default-cert";
    private static final String FQDN = "sepp.ericsson.se";

    /**
     * @param config
     */
    public SeppManager(Configuration config)
    {
        super(config);
    }
