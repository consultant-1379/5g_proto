...
public final class Telegraf extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    ...
    private static final String KEY_NAME = "sc-telegraf-default-key";
    private static final String CERT_NAME = "sc-telegraf-default-cert";

    private static final String FQDN = "eric-telegraf";

    /**
     * @param config
     */
    public Telegraf(Configuration config)
    {
        super(config);
    }
