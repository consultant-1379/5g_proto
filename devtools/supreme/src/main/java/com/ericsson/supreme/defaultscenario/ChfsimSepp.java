...
public final class ChfsimSepp extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    ...
    private static final String SECRET_NAME = "chf-sepp-certificates";

    private static final String FQDN = "eric-chfsim-1-mnc-123-mcc-123";

    /**
     * @param config
     */
    public ChfsimSepp(Configuration config)
    {
        super(config);
    }
    ...
    public void createCerts(GeneratedCert ca) throws DefaultScenarioException
    {
        this.cert = super.defaultCreateCerts(NAME,
                                             FQDN,
                                             List.of(FQDN,
                                                     "eric-chfsim-2-mnc-123-mcc-123",
                                                     "eric-chfsim-3-mnc-456-mcc-456",
                                                     "eric-chfsim-4-mnc-456-mcc-456",
                                                     "eric-chfsim-5-mnc-456-mcc-456",
                                                     "eric-chfsim-6-mnc-456-mcc-456",
                                                     "eric-chfsim-7-mnc-456-mcc-456",
                                                     "eric-chfsim-8-mnc-456-mcc-456"),
                                             ca);
    }
