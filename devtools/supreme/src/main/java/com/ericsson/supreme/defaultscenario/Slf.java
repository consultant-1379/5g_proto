...
public final class Slf extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "slf";

    private static final String KEY_NAME = "sc-nrf-default-key";
    private static final String CERT_NAME = "sc-nrf-default-cert";

    private static final String FQDN = "eric-sc-slf";

    /**
     * @param config
     */
    public Slf(Configuration config)
    {
        super(config);
    }
