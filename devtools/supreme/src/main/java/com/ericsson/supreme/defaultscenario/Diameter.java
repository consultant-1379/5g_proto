...
public final class Diameter extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "diameter";

    private static final String KEY_NAME = "diameter-key-cert";
    private static final String CERT_NAME = "diameter-key-cert";
     ...
     * @param config
     */
    public Diameter(Configuration config)
    {
        super(config);
    }
