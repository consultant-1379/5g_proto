...
public final class NetconfTlsClient extends AbstractDefaultScenario implements DefaultScenario, Processor
{
    private GeneratedCert cert;
    private Processor nextProcessor;

    private static final String NAME = "netconf-tls-client";
    private static final String CN = "cmyp";
    private static final String SEC_ADMIN = "sec-admin";

    /**
     * @param config
     */
    public NetconfTlsClient(Configuration config)
    {
        super(config);
    }
    ...
    {
        this.cert = super.defaultCreateCerts(NAME, CN, List.of("DirName:CN=" + SEC_ADMIN, "*"), ca);
    }

    @Override
    public void installCerts(KubernetesClient kubeClient) throws DefaultScenarioException
    {
        // the certificate and key are generated but do not get installed
        // the are used in test cases
    }
